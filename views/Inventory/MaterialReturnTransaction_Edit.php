...
<div id="content" class="content">
	...
	<li class="active">Edit Material Return Transaction</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Material Return Transaction <small> Enter the correct details here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Edit Material Return Transaction</h4>
		</div>
		<div class="panel-body">
                        <form id="form_validation22" method="POST" enctype="multipart/form-data" action="<?php echo site_url('InventoryController/MaterialReturnTransaction_Edit');?>" class="form-horizontal">
			    <div class="row">
			    <label class="col-md-1 control-label">Transaction Code</label>
			    <div class="col-md-2">
				<input type="hidden" name="MRH_SYS_ID"  value="<?=$FetchHead[0]['MRH_SYS_ID']?>" >
				<input type="hidden" name="MRH_TXN_NO"  value="<?=$FetchHead[0]['MRH_TXN_NO']?>" >
				    <input type="text" name="mrh_txn_code"  readonly="" placeholder="MRH_TXN_CODE" value="<?=$FetchHead[0]['MRH_TXN_CODE']?>"  class="form-control">
                            </div>
			    <label class="col-md-1 control-label">Transaction Type</label>
			    <div class="col-md-2">
				    <input type="text" name="mrh_txn_type" placeholder="MRH_TXN_TYPE" value="<?=$FetchHead[0]['MRH_TYPE']?>" class="form-control">
                            </div>
			    <label class="col-md-1 control-label">Doc Number</label>
			    <div class="col-md-2">
				<input type="text" name="mrh_doc_no" readonly="" value="<?=$FetchHead[0]['MRH_TXN_NO']?>" placeholder="MRH_DOC_NO" id="mrh_doc_no" class="form-control">
			    </div>
			   <label class="col-md-1 control-label">Doc Date</label>
			   <div class="col-md-2">
				<input type="text" name="mrh_doc_DT" placeholder="MRH_DOC_DT"  id="datepicker" value="<?=$FetchHead[0]['MRH_TXN_DT']?>" id="mrh_doc_dt" class="form-control">
			    </div>
                           </div>
			     <div class="row p-t-20">
			    <label class="col-md-1 control-label">Description</label>
			    <div class="col-md-5">
				<input type="text" name="mrh_desc" id="mrh_desc" value="<?=$FetchHead[0]['MRH_DESC']?>" placeholder="MRH_DESC" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Status</label>
			    <div class="col-md-2">
				<input type="text" name="mrh_status" placeholder="MRH_STATUS" value="<?=$FetchHead[0]['MRH_STATUS']?>" id="mrh_status" class="form-control">
			    </div>
				...
				<select name="mih_src_loc" class="form-control">
				    ...
				    <option <?=$row['RQH_DLV_LOCN_CODE'] == $FetchHead[0]['MRH_SRC_LOCN_CODE'] ? 'selected="selected"' : '';?> value="<?=$row['RQH_DLV_LOCN_CODE']?>" ><?=$row['RQH_DLV_LOCN_CODE']?></option>
				    <?php } ?>
				</select>
			    </div>
			    ...
			    <div class="p-t-20 col-md-12">
						...
						<?php //print_r($Fetchline);
						//echo count($Fetchline);
						?>
							    ...
							    <th><center>Line</center></th>
                                                    ...
                                                    <tbody id="result_pulling_lines">
                                                        <?php if(count($Fetchline)>0) { ?>
                                                        <tr  class="odd">
							<input type="hidden" class="form-control" name="MRL_REF_LINE_SYS_ID[]" value="<?=$Fetchline[0]['MRL_REF_LINE_SYS_ID']?>" >
							<input type="hidden" class="form-control" name="MRL_SYS_ID[]" value="<?=$Fetchline[0]['MRL_SYS_ID']?>" >
							<input type="hidden" class="form-control" name="mrl_mrh_sys_id[]" value="<?=$Fetchline[0]['MRL_MRH_SYS_ID']?>" >
							<input type="hidden" class="form-control" name="mrl_txn_flow_seq[]" value="<?=$Fetchline[0]['MRL_REF_FLOW_SEQ']?>" >
							<input type="hidden" class="form-control" name="mrl_price[]" value="<?=$Fetchline[0]['MRL_PRICE']?>" >
							<input type="hidden" class="form-control" name="mrl_dlv_loc_code[]" value="<?=$Fetchline[0]['MRL_DLV_LOCN_CODE']?>" >
							<input type="hidden" class="form-control" name="mrl_src_loc_code[]" value="<?=$Fetchline[0]['MRL_SRC_LOCN_CODE']?>" >
							<input type="hidden" class="form-control" name="mrl_dlv_dt[]" value="<?=$Fetchline[0]['MRL_DLV_DT']?>" >
							<td><span><input type="text" class="form-control" name="mrl_line[]" value="<?=$Fetchline[0]['MRL_LINE']?>" ></span></td>
							<td><span><input type="text" class="form-control" name="mrl_txn_code[]" value="<?=$Fetchline[0]['MRL_REF_TXN_CODE']?>" ></span></td>
							<td><span><input type="text" class="form-control" name="mrl_txn_no[]" value="<?=$Fetchline[0]['MRL_REF_TXN_NO']?>" ></span></td>
							<td><span><input type="text" class="form-control" name="mrl_item_code[]" value="<?=$Fetchline[0]['MRL_ITEM_CODE']?>" ></span></td>
							<td><span><input type="text" class="form-control" name="mrl_item_desc[]" value="<?=$Fetchline[0]['MRL_ITEM_DESC']?>" ></span></td>
							<td><span><input type="text" class="form-control" name="mrl_uom_code[]" value="<?=$Fetchline[0]['MRL_UOM_CODE']?>" ></span></td>
							<td><span><input type="text" class="form-control" name="mrl_qty[]" value="<?=$Fetchline[0]['MRL_QTY']?>" ></span></td>
							<td><span><input type="text" class="form-control" name="mrl_desc[]" value="<?=$Fetchline[0]['MRL_DESC']?>" ></span></td>
