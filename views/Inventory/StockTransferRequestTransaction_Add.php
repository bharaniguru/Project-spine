...
<div id="content" class="content">
	...
	<li class="active">Add Stock Transfer Request Transaction</li>	
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Add Stock Transfer Request Transaction <small> Enter the correct details here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Add Stock Transfer Request Transaction</h4>
		</div>
		<div class="panel-body">
                        <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo site_url('InventoryController/StockTransferRequestTransaction_Add');?>" class="form-horizontal">
			    <div class="row">
			    <label class="col-md-1 control-label">Transaction Code</label>
			    <div class="col-md-2">
				<input type="text" placeholder="TXN_CODE" name="srqh_txn_code" value="STR" class="form-control" readonly>
                            </div>
			    ...
			    <div class="col-md-2">
				<input type="text" name="srqh_txn_no" value="<?php echo $result['return_status']?>" placeholder="MIH_TXN_TYPE" id="srqh_txn_no" class="form-control" readonly>
			    </div>
			   <label class="col-md-1 control-label">Txn Date</label>
			   <div class="col-md-2">
				<input type="text" name="srqh_txn_dt" id="datepicker" placeholder="STRH_TXN_DATE" value="<?php echo date('d-M-y');?>" class="form-control" />
			    </div>
			    </div>
			     <div class="row p-t-20">
			    <label class="col-md-1 control-label">Requested By</label>
			    <div class="col-md-5">
				<input type="text" name="srqh_req_by" id="srqh_req_by" placeholder="SRQH_REQUESTED_BY" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Description</label>
			    <div class="col-md-2">
				<input type="text" name="srqh_desc" id="srqh_desc" placeholder="STRH_DESC" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Status</label>
			    <div class="col-md-2">
				<input type="text" name="srqh_status" id="srqh_status" placeholder="STRH_STATUS" class="form-control">
			    </div>
                           </div>
				...
				<select name="srqh_dlv_loc" class="form-control">
				    ...
				    <option value="<?php echo $row1['LOCN_CODE']?>"><?php echo $row1['LOCN_DESC']?></option>
				    <?php } ?>
				</select>
				<input type="hidden" name="srqh_dlv">
			    </div>
				...
				<input type="hidden" name="srqh_src">
			    </div>
			    <label class="col-md-1 control-label">Delivery Date</label>
			    <div class="col-md-2">
				<input type="text" name="strh_delv_dt" id="datepicker1" placeholder="STRH_DELV_DT" class="form-control">
			    </div>
			    ...
			    <div class="p-t-20 col-md-12">
				    ...
				    <div id="nav-pills-tab-2" class="tab-pane fade">
							    ...
							    <th><center>Line</center></th>
                                                    ...
                                                    <tbody>
							<tr class="odd">                                                
							    <td><span><input type="text" name="srql_line[]" class="form-control" value="1"/></span></td>
							    <td><span><select name="srql_item_code[]" class="form-control">
								<option>Select</option>
								<?php foreach($result2 as $row2) {?>
								<option value="<?php echo $row2['ITEM_CODE']?>"><?php echo $row2['ITEM_DESC']?></option>
								<?php } ?>
							    </select></span></td>
