...
<div id="content" class="content">
	...
	<li class="active">Add Stock Adjustment Transaction</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Add Stock Adjustment Transaction <small> Enter the correct details here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Add Stock Adjustment Transaction</h4>
		</div>
		<div class="panel-body">
                        <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo site_url('InventoryController/StockAdjustmentTransaction_Add');?>" class="form-horizontal">
				...
				<div class="input-group">
				    <input type="text" name="SAH_TXN_CODE" id="SAH_TXN_CODE" value="SAD" class="form-control" readonly/>
				    ...
				    <input type="text" name="SAH_TXN_DESC" id="SAH_TXN_DESC" value="Stock Adjustment" class="form-control" readonly/>
			    ...
			    <div class="col-md-2">
				<input type="text" name="sah_doc_no" placeholder="STRH_TXN_NO" id="mih_doc_no" value="<?php echo $GetStrnTxnNo['return_status'] ?>" readonly class="form-control">
			    </div>
			   <label class="col-md-1 control-label">Txn Date</label>
			   <div class="col-md-2">
				<input type="text" name="SAH_TXN_DT" placeholder="SAH_TXN_DT" id="SAH_TXN_DT"  class="form-control input-group datepicker-txn">
				...
				<select name="SAH_LOCN_CODE" placeholder="SAH_LOCN_CODE" id="SAH_LOCN_CODE" class="form-control">
					...
					<option value="<?php echo $lc['LOCN_CODE'] ?>"><?php echo $lc['LOCN_DESC'] ?></option>
					<?php }?>
                                    </select>
			    </div>
			    </div>
			    ...
			    <div class="col-md-5">
				<input type="text" name="SAH_DESC" id="SAH_DESC" placeholder="SAH_DESC" class="form-control">
			    </div>
			    </div>
			    <div class="row p-t-20">
			    <label class="col-md-1 control-label"></label>
			    <div class="col-md-2">
				<input type="hidden" name="sah_inv_no" id="sah_inv_no" placeholder="SAH_INV_NO" class="form-control">
			    </div>
			    <label class="col-md-3 control-label"></label>
			    <label class="col-md-1 control-label">Status</label>
			    <div class="col-md-2">
				<input type="text" name="SAH_STATUS" placeholder="SAH_STATUS" id="SAH_STATUS" class="form-control">
			    </div>
			    <label class="col-md-1 control-label"></label>
			    <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-md-1 control-label">Flex 01</label>
                                                    <div class="col-md-4">
                                                        <input type="text" name="SAH_FLEX_01" placeholder="SAH_FLEX_01" id="sah_flix_01" class="form-control">
                                                    </div>
						<label class="col-md-1 control-label">Flex 11</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_11" placeholder="SAH_FLEX_11" id="sah_flix_11" class="form-control">
                                                    </div>    
                                            </div>
					    <div class="form-group">
                                                <label class="col-md-1 control-label">Flex 02</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_02" placeholder="SAH_FLEX_02" id="sah_flix_02" class="form-control">
                                                    </div>
						<label class="col-md-1 control-label">Flex 12</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_12" placeholder="SAH_FLEX_12" id="sah_flix_12" class="form-control">
						    </div>    
                                            </div>
					    <div class="form-group">
                                                <label class="col-md-1 control-label">Flex 03</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_03" placeholder="SAH_FLEX_03" id="sah_flix_03" class="form-control">
						    </div>
						<label class="col-md-1 control-label">Flex 13</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_13" placeholder="SAH_FLEX_13" id="sah_flix_13" class="form-control">
						    </div>    
                                            </div>
					    <div class="form-group">
                                                <label class="col-md-1 control-label">Flex 04</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_04" placeholder="SAH_FLEX_04" id="sah_flix_04" class="form-control">
						    </div>
						<label class="col-md-1 control-label">Flex 14</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_14" placeholder="SAH_FLEX_14" id="sah_flix_14" class="form-control">
						    </div>    
                                            </div>
					    <div class="form-group">
                                                <label class="col-md-1 control-label">Flex 05</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_05" placeholder="SAH_FLEX_05" id="sah_flix_05" class="form-control">
						    </div>
						<label class="col-md-1 control-label">Flex 15</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_15" placeholder="SAH_FLEX_15" id="sah_flix_15" class="form-control">
						    </div>    
                                            </div>
					    <div class="form-group">
                                                <label class="col-md-1 control-label">Flex 06</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_06" placeholder="SAH_FLEX_06" id="sah_flix_06" class="form-control">
						    </div>
						<label class="col-md-1 control-label">Flex 16</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_16" placeholder="SAH_FLEX_16" id="sah_flix_16" class="form-control">
						    </div>    
                                            </div>
					    <div class="form-group">
                                                <label class="col-md-1 control-label">Flex 07</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_07" placeholder="SAH_FLEX_07" id="sah_flix_07" class="form-control">
						    </div>
						<label class="col-md-1 control-label">Flex 17</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_17" placeholder="SAH_FLEX_17" id="sah_flix_17" class="form-control">
						    </div>    
                                            </div>
					    <div class="form-group">
                                                <label class="col-md-1 control-label">Flex 08</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_08" placeholder="SAH_FLEX_08" id="sah_flix_08" class="form-control">
						    </div>
						<label class="col-md-1 control-label">Flex 18</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_18" placeholder="SAH_FLEX_18" id="sah_flix_18" class="form-control">
						    </div>    
                                            </div>
					    <div class="form-group">
                                                <label class="col-md-1 control-label">Flex 09</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_09" placeholder="SAH_FLIX_09" id="sah_flix_09" class="form-control">
						    </div>
						<label class="col-md-1 control-label">Flex 19</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_19" placeholder="SAH_FLEX_19" id="sah_flix_19" class="form-control">
						    </div>    
                                            </div>
					    <div class="form-group">
                                                <label class="col-md-1 control-label">Flex 10</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_10" placeholder="SAH_FLIX_10" id="sah_flix_10" class="form-control">
						    </div>
						<label class="col-md-1 control-label">Flex 20</label>
                                                    <div class="col-md-4">
							<input type="text" name="SAH_FLEX_20" placeholder="SAH_FLEX_20" id="sah_flix_20" class="form-control">
						    </div>    
                                            </div>
                                        </div>
                                    </div>
							    ...
							    <td><input type="text" name="SAL_LINE[]" id="SAL_LINE[]" value="1"></td>
							    <td>
							    ...
							    <td><input type="text" name="SAL_ITEM_DESC[]" id="SAL_ITEM_DESC[]" readonly></td>
							    <td><input type="text" name="SAL_UOM_CODE[]" id="SAL_UOM_CODE[]" readonly></td>
							    <td><input type="text" name="SAL_SYS_QTY[]" id="SAL_SYS_QTY[]" ></td>
							    <td><input type="text" name="SAL_ADJ_QTY[]" id="SAL_ADJ_QTY[]" ></td>
							    <td><input type="text" name="SAL_QTY_AFT_ADJ[]" id="SAL_QTY_AFT_ADJ[]"  readonly></td>
							    <td><input type="text" name="SAL_PRICE[]" id="SAL_PRICE[]" ></td>
							    <td><input type="text" name="SAL_SYS_VALUE[]" id="SAL_SYS_VALUE[]" ></td>
							    <td><input type="text" name="SAL_ADJ_VALUE[]" id="SAL_ADJ_VALUE[]" ></td>
							    <td><input type="text" name="SAL_VALUE_AFT_ADJ[]" id="SAL_VALUE_AFT_ADJ[]" ></td>
							    <td><input type="text" name="SAL_DESC[]" id="SAL_DESC[]" ></td>
							    ...
							    <td><input type="text" name="SAL_LINE[]" ></td>
							    <td>
								<select name="SAL_ITEM_CODE[]" id="SAL_ITEM_CODE">
...
$clone.find('[name="SAL_LINE[]"]').val(row_count);
