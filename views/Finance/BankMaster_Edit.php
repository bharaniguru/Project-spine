		    ...
		    <div class=" col-md-12">
					...
					<div class="tab-content">
						...
						<div class="col-md-5">
							...
							<div class="col-md-9">
							    <input type="text" name="BANK_ADD1" id="BANK_ADD1" class="form-control" placeholder="BANK_ADD1" value="<?php echo $bank[0]['BANK_ADDR1']; ?>"/>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-2 control-label">&nbsp;</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_ADD2" id="BANK_ADD2" class="form-control" placeholder="BANK_ADD2" value="<?php echo $bank[0]['BANK_ADDR2']; ?>"/>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-2 control-label">&nbsp;</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_ADD3" id="BANK_ADD3" class="form-control" placeholder="BANK_ADD3" value="<?php echo $bank[0]['BANK_ADDR3']; ?>"/>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-2 control-label">&nbsp;</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_ADD4" id="BANK_ADD4" class="form-control" placeholder="BANK_ADD4" value="<?php echo $bank[0]['BANK_ADDR4']; ?>"/>
							</div>
						    </div>
						    <div class="form-group">
							...
							<select name="BANK_CN_CODE" id="BANK_CN_CODE" class="form-control">
							    ...
							    <option <?php if($bank[0]['BANK_CN_CODE']==$country['CN_CODE']) echo "selected"; ?> value="<?php echo $country['CN_CODE']; ?>" ><?php echo $country['CN_DESC']; ?></option>
							    <?php } ?>
							</select>
							</section>
							</div>
							...
							<select name="BANK_ST_CODE" id="BANK_ST_CODE" class="form-control">
							    ...
							    <?php foreach( $state as $state){?>
								   ...
								   <option <?php if($bank[0]["BANK_ST_CODE"]==$state['ST_CODE']) echo "selected"; ?> value="<?php echo $state['ST_CODE']; ?>"><?php echo $state['ST_DESC']; ?></option>
								    <?php }?>
								</select>
							</section>
							</div>
							...
							<select name="BANK_CT_CODE" id="BANK_CT_CODE" class="form-control">
								    ...
								    <option <?php if($bank[0]["BANK_CT_CODE"]==$city['CT_CODE']) echo "selected"; ?> value="<?php echo $city['CT_CODE']; ?>"><?php echo $city['CT_DESC']; ?></option>
								    <?php }?>
								</select>
							</section>
							</div>
							...
							<div class="col-md-9">
							    <input type="text" name="BANK_POSTAL" id="BANK_POSTAL" class="form-control" placeholder="BANK_POSTAL" value="<?php echo $bank[0]['BANK_POSTAL']; ?>"/>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-2 control-label">Mobile</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_MOBILE" id="BANK_MOBILE" class="form-control" placeholder="BANK_MOBILE" value="<?php echo $bank[0]['BANK_MOBILE']; ?>"/>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-2 control-label">Phone</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_PHONE" id="BANK_PHONE" class="form-control" placeholder="BANK_PHONE" value="<?php echo $bank[0]['BANK_PHONE']; ?>"/>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-2 control-label">Fax</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_FAX" id="BANK_FAX" class="form-control" placeholder="BANK_FAX" value="<?php echo $bank[0]['BANK_FAX']; ?>"/>
							</div>
						    </div>
						     <div class="form-group">
							<label class="col-md-2 control-label">Email</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_EMAIL" id="BANK_EMAIL" class="form-control" placeholder="BANK_EMAIL" value="<?php echo $bank[0]['BANK_EMAIL']; ?>"/>
							</div>
						    </div>
						      <div class="form-group">
							<label class="col-md-2 control-label">Website</label>
							<div class="col-md-9">
						      	    <input type="text" name="BANK_WEB_SITE" id="BANK_WEB_SITE" class="form-control" placeholder="BANK_WEB_SITE" value="<?php echo $bank[0]['BANK_WEB_SITE']; ?>"/>
							</div>
						    </div>
						</div>
						</div>
						...
						<div class="widget-body">
							...
							<div class="col-md-9">
							    <input type="text" name="BANK_ACNT_NUMBER" id="BANK_ACNT_NUMBER" class="form-control" placeholder="BANK_ACNT_NUMBER" value="<?php echo $bank[0]['BANK_ACNT_NUMBER']; ?>"/>
							</div>
						    </div>
							  <div class="form-group">
							<label class="col-md-2 control-label">IBAN</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_ACNT_IBAN" id="BANK_ACNT_IBAN" class="form-control" placeholder="BANK_ACNT_IBAN" value="<?php echo $bank[0]['BANK_ACNT_IBAN']; ?>"/>
							</div>
						    </div>
							   <div class="form-group">
							<label class="col-md-2 control-label">SWIFT Code</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_SWIFT_CODE" id="BANK_SWIFT_CODE" class="form-control" placeholder="BANK_SWIFT_CODE" value="<?php echo $bank[0]['BANK_SWIFT_CODE']; ?>"/>
							</div>
						    </div>
							     <div class="form-group">
							...
							<select name="BANK_ACNT_CCY_CODE" id="BANK_ACNT_CCY_CODE" class="form-control">
							    ...
							    <?php if (count($currency) > 0 )
									...
									<option <?php if($bank[0]["BANK_ACNT_CCY_CODE"]==$row['CCY_CODE']) echo "selected"; ?> value="<?php echo $row['CCY_CODE']; ?>"><?php echo $row['CCY_DESC']; ?></option>
								       <?php } }?>   
								</select>
							</section>
							</div>
							...
							<div class="col-md-9">
							    <input type="text" name="BANK_MIN_BAL" id="BANK_MIN_BAL" class="form-control" placeholder="BANK_MIN_BAL" value="<?php echo $bank[0]['BANK_MIN_BAL']; ?>"/>
							</div>
						    </div>
							      <div class="form-group">
							<label class="col-md-2 control-label">Online Banking User ID</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_ACNT_USERID" id="BANK_ACNT_USERID" class="form-control" placeholder="BANK_ACNT_USERID" value="<?php echo $bank[0]['BANK_ACNT_USERID']; ?>"/>
							</div>
						    </div>
							       <div class="form-group">
							<label class="col-md-2 control-label">AC Manager</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_ACNT_MANAGER" id="BANK_ACNT_MANAGER" class="form-control" placeholder="BANK_ACNT_MANAGER" value="<?php echo $bank[0]['BANK_ACNT_MANAGER']; ?>"/>
							</div>
						    </div>
							...
							<div class="col-md-9">
							    <input type="text" name="BANK_WORK_DAYS" id="BANK_WORK_DAYS" class="form-control" placeholder="BANK_WORK_DAYS" value="<?php echo $bank[0]['BANK_WORK_DAYS']; ?>"/>
							</div>
						    </div>
							    <div class="form-group">
							<label class="col-md-2 control-label">Work Time</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_WORK_TIME" id="BANK_WORK_TIME" class="form-control" placeholder="BANK_WORK_TIME" value="<?php echo $bank[0]['BANK_WORK_TIME']; ?>"/>
							</div>
						    </div>
							     <div class="form-group">
							<label class="col-md-2 control-label">Clearing TIme</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_CLEAR_TIME" id="BANK_CLEAR_TIME" class="form-control" placeholder="BANK_CLEAR_TIME" value="<?php echo $bank[0]['BANK_CLEAR_TIME']; ?>"/>
							</div>
						    </div>
							      <div class="form-group">
							<label class="col-md-2 control-label">From Date</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_ACNT_FROM_DT" id="BANK_ACNT_FROM_DT" class="form-control datepicker-txn" placeholder="BANK_ACNT_FROM_DT" value="<?php echo $bank[0]['BANK_ACNT_FROM_DT']; ?>"/>
							</div>
							      </div>
							       <div class="form-group">
							<label class="col-md-2 control-label">Upto Date</label>
							<div class="col-md-9">
							    <input type="text" name="BANK_ACNT_UPTO_DT" id="BANK_ACNT_UPTO_DT" class="form-control datepicker-txn" placeholder="BANK_ACNT_UPTO_DT" value="<?php echo $bank[0]['BANK_ACNT_UPTO_DT']; ?>"/>
							</div>
						    </div>
						</div>
						</div>
						...
						<div class="row">
							...
							<div class="table-responsive">
								...
								<tbody>
								     <?php
								    $count=count($GetbankmasterDoc);
								    foreach($GetbankmasterDoc as $row)
								    {  ?>
								   <tr class="odd_file">
								       <td>
								    ...
								    <td>
									<input type="file" data-filename-placement="inside" class="btn btn-success  form-control" value="<?php echo $row["BD_FILE_NAME"];?>" id="BD_FILE_NAME" name="userfile[]">
								    
								    </td>
								    <td>
									<input type="text" id="BD_DESC " name="BD_DESC[]" class="form-control" value="<?php echo $row["BD_DESC"];?>" placeholder="BD_DESC" />
								    </td>
								    <td>
									<input type="text" id="BD_FROM_DT " name="BD_FROM_DT[]" class="form-control datepicker-txn" value="<?php echo $row["BD_FROM_DT"];?>"  placeholder="BD_FROM_DT" />
								    </td>
								    <td>
									<input type="text" id="BD_UPTO_DT " name="BD_UPTO_DT[]" class="form-control datepicker-txn" value="<?php echo $row["BD_UPTO_DT"];?>" placeholder="BD_UPTO_DT" />
								    </td>
								    
								    <td><button type="button" class="btn  btn-sm btn-danger" data-template="textbox">Remove</button></td>
