		...
		<ol class="breadcrumb pull-right">
		    ...
		    <li class="active">Add Job Request Transaction</li>
		</ol>
		<!-- end breadcrumb -->
		<!-- begin page-header -->
		<h1 class="page-header">Add Job Request Transaction<small> Enter the correct details here...</small></h1>
		<!-- end page-header -->
		<!-- begin row -->
		<div class="row">
		    <!-- begin col-12 -->
			...
			<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
				...
				<h4 class="panel-title">Add Job Request Transaction</h4>
			    </div>
			    <div class="panel-body">
				<p style="color:red"><?php echo $status; ?></p>
				<form action="<?php echo base_url('LogisticsController/JobRequestTransaction_Add'); ?>"  class="form-horizontal  form12" method="POST">
				    <div id="wizard">
				    <ol>
					<li>Reference</li>
					<li>Address</li>
					...
					<fieldset>
						...
						<div class="col-md-11">
							...
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_REF_TXN_CODE"  name="JRH_REF_TXN_CODE" id="JRH_REF_TXN_CODE" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Reference Doc No</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_REF_TXN_NO"  name="JRH_REF_TXN_NO" id="JRH_REF_TXN_NO" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							...
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_REF_TXN_DT"  name="JRH_REF_TXN_DT" id="JRH_REF_TXN_DT" class="form-control input-group datepicker-txn">
							    <!--<input type="text" placeholder="JRH_APPOINT_DT" name="JRH_APPOINT_DT" id="JRH_APPOINT_DT" class="form-control input-group datepicker-dob"  >-->
							...
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_CONTACT_NO"  name="JRH_CONTACT_NO" id="JRH_CONTACT_NO" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Contact Person</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_CONTACT_PERSON"  name="JRH_CONTACT_PERSON" id="JRH_CONTACT_PERSON" class="form-control">
							</div>
						    </div>
					...
					<fieldset>
						...
						<div class="col-md-11">
							...
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_ADD1"  name="JRH_ADD1" id="JRH_ADD1" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label"></label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_ADD2"  name="JRH_ADD2" id="JRH_ADD2" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label"></label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_ADD3"  name="JRH_ADD3" id="JRH_ADD3" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label"></label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_ADD4"  name="JRH_ADD4" id="JRH_ADD4" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							...
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_POSTAL"  name="JRH_POSTAL" id="JRH_POSTAL" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Mobile</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_MOBILE"  name="JRH_MOBILE" id="JRH_MOBILE" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Phone</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_PHONE"  name="JRH_PHONE" id="JRH_PHONE" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Fax</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_FAX"  name="JRH_FAX" id="JRH_FAX" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Email</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_EMAIL"  name="JRH_EMAIL" id="JRH_EMAIL" class="form-control">
							</div>
						    </div>
						    <button class="btn btn-sm btn-danger" type="button" onclick="window.history.back();">Cancel</button>
						</div>
					...
					<fieldset>
						...
						<div class="col-md-11">
							...
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_CUST_ID"  name="JRH_CUST_ID" id="JRH_CUST_ID" class="form-control" >
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Customer Account</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_CUST_AC_CODE"  name="JRH_CUST_AC_CODE" id="JRH_CUST_AC_CODE" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Description</label>
							<div class="col-md-5">
							    <textarea rows="5" placeholder="JRH_CUST_AC_DESC" name="JRH_CUST_AC_DESC" id="JRH_CUST_AC_DESC" class="form-control"></textarea>
							</div>
						    </div>
						    <div class="form-group">
					...
					<fieldset>
						...
						<div class="col-md-11">
							...
							<label class="col-md-3 control-label">Reference From</label>
							<div class="col-md-5">
							   <input type="text" id="JRH_REF_FROM" name="JRH_REF_FROM" value=""  class="form-control" readonly>
							    <!--<select class="form-control" id="JRH_REF_FROM" name="JRH_REF_FROM" data-parsley-group="pull-left width-full" required >-->
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Reference Txn</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_REF_TXN_CODE"  name="JRH_REF_TXN_CODE" id="JRH_REF_TXN_CODE" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Reference Doc No</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_REF_TXN_NO"  name="JRH_REF_TXN_NO" id="JRH_REF_TXN_NO" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Job Code</label>
							<div class="col-md-5">
							    <input type="text"  id="JRH_JOB_CODE" name="JRH_JOB_CODE" class="form-control" readonly>
							    <!--     <select class="form-control" id="JRH_JOB_CODE" name="JRH_JOB_CODE">-->
							    <!--	<option disabled selected value="">Select</option>-->
							    <!--	<?php //foreach($result8 as $cn){ ?>-->
							    <!--	-->
							...
							<label class="col-md-3 control-label">Reference Txn Dt</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_REF_TXN_DT"  name="JRH_REF_TXN_DT" id="JRH_REF_TXN_DT" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Contact Number</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_CONTACT_NO"  name="JRH_CONTACT_NO" id="JRH_CONTACT_NO" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Contact Person</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_CONTACT_PERSON"  name="JRH_CONTACT_PERSON" id="JRH_CONTACT_PERSON" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Address</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_ADD1"  name="JRH_ADD1" id="JRH_ADD1" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label"></label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_ADD2"  name="JRH_ADD2" id="JRH_ADD2" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label"></label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_ADD3"  name="JRH_ADD3" id="JRH_ADD3" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label"></label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_ADD4"  name="JRH_ADD4" id="JRH_ADD4" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Country</label>
							<div class="col-md-5">
							   <input type="text"  id="JRH_CN_CODE" name="JRH_CN_CODE" class="form-control" readonly>
							    <!--    <select class="form-control" id="JRH_CN_CODE" name="JRH_CN_CODE">-->
							    <!--	<option disabled selected value="">Select</option>-->
							    <!--	<?php //foreach($result1 as $cn){ ?>-->
							    <!--	-->
							...
							<label class="col-md-3 control-label">State</label>
							<div class="col-md-5">
							    <input type="text"  id="JRH_ST_CODE" name="JRH_ST_CODE" class="form-control" readonly>
							    <!--    <select class="form-control" id="JRH_ST_CODE" name="JRH_ST_CODE">-->
							    <!--	<option disabled selected value="">Select</option>-->
							    <!--	<?php// foreach($result6 as $cn){ ?>-->
							    <!--	-->
							...
							<label class="col-md-3 control-label">City</label>
							<div class="col-md-5">
							   <input type="text"  id="JRH_CT_CODE" name="JRH_CT_CODE" class="form-control" readonly>
							...
							<label class="col-md-3 control-label">PO Box</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_POSTAL"  name="JRH_POSTAL" id="JRH_POSTAL" class="form-control" readonly >
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Mobile</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_MOBILE"  name="JRH_MOBILE" id="JRH_MOBILE" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Phone</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_PHONE"  name="JRH_PHONE" id="JRH_PHONE" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Fax</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_FAX"  name="JRH_FAX" id="JRH_FAX" class="form-control" readonly> 
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Email</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_EMAIL"  name="JRH_EMAIL" id="JRH_EMAIL1" class="form-control" readonly>
							</div>
						    </div>
							...
							<label class="col-md-3 control-label">Customer ID</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_CUST_ID"  name="JRH_CUST_ID" id="JRH_CUST_ID1" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Customer Account</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_CUST_AC_CODE"  name="JRH_CUST_AC_CODE" id="JRH_CUST_AC_CODE1" class="form-control" readonly>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Description</label>
							<div class="col-md-5">
							    <textarea rows="5" placeholder="JRH_CUST_AC_DESC" name="JRH_CUST_AC_DESC" id="JRH_CUST_AC_DESC" class="form-control" readonly></textarea>
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-3 control-label">Appoinment Date</label>
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_APPOINT_DT" name="JRH_APPOINT_DT" id="JRH_APPOINT_DT1" readonly class="form-control "  >
							    <!--<input type="text" placeholder="From Date" name="pt_from_date[]" id="CCY_FROM_DT" class="input-group input-daterange form-control datepicker-dob" >-->
							</div>
						    </div>
						    <div class="form-group">
							...
							<div class="col-md-5">
							    <input type="text" placeholder="JRH_REQUEST_BY"  name="JRH_REQUEST_BY" id="JRH_REQUEST_BY" class="form-control">
							</div>
						    </div>
						    <div class="form-group">
							<label class="col-md-2 control-label">Txn Code</label>
							<div class="col-md-2">
							    <input type="text" placeholder="JRH_TXN_CODE" readonly name="JRH_TXN_CODE" id="JRH_TXN_CODE" class="form-control">
							</div>
							<label class="col-md-1 control-label">Txn Num</label>
							<div class="col-md-2">
							    <input type="text" placeholder="JRH_TXN_NO" readonly  name="JRH_TXN_NO" id="JRH_TXN_NO" class="form-control">
							</div>
							<label class="col-md-1 control-label">Date</label>
							<div class="col-md-2">
							    <input type="text" placeholder="JRH_TXN_DT" readonly  name="JRH_TXN_DT" id="JRH_TXN_DT" class="form-control">
							</div>
						    </div>
