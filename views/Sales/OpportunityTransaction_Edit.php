...
$limit=count($prod_code);
for($i=0;$i<$limit;$i++){
   $code[]=$prod_code[$i]['IF_CODE'];
}
$prod=explode(",",$opp[0]['OPL_PRODUCT_CODE']);
...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Opportunity Transaction <small> You may edit here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12 ui-sortable">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Opportunity Transaction Edit</h4>
                        </div>
                        <div class="panel-body">
			   <p style="color: #EB4688"><?php if (isset($error_message)) { echo $error_message; } ?></p>
                            <form class="form-horizontal" name="myForm" id="myForm" enctype="multipart/form-data" action="<?php echo base_url();?>Sales/OpportunityTransaction_Edit" method="post">
                                <div id="wizard">
                                        <ol>
                                                <li id="one">
                                                    Opportunity 
                                                ...
                                                <div class="row form-horizontal"><!--OUTER row defined BEGIN-->
                                                    <div class="col-md-6 "><!-- FIRST COL-6 BEGIN-->
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" placeholder="OPH_CONTACT_NO"  name="CONTACT_NO" id="CONTACT_NO" class="form-control" value="<?php echo $opp[0]['OPH_CONTACT_NO']; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label">
                                                            ...
                                                            <div class="col-md-8">
                                                            <input type="text" placeholder="OPH_CONTACT_PERSON"  name="CONTACT_PERSON" id="CONTACT_PERSON" class="form-control" value="<?php echo $opp[0]['OPH_CONTACT_PERSON']; ?>">
                                                            </div>
                                                        </div>
                                                    </div><!-- First col 6 end-->
                                                    ...
                                                    <div class="col-md-6 ui-sortable"><!-- Second COL-6 BEGIN-->
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" placeholder="OPH_OPPORTUNITY"  name="OPPORTUNITY" id="OPPORTUNITY" class="form-control" value="<?php echo $opp[0]['OPH_OPPORTUNITY']; ?>">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row form-horizontal"><!--OUTER row defined BEGIN-->
                                                    <div class="col-md-6 "><!-- FIRST COL-6 BEGIN-->
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="ADD1" name="ADD1" class="form-control" placeholder="OPH_ADD1" value="<?php echo $opp[0]['OPH_ADD1']; ?>"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label"></label>
                                                            <div class="col-md-8">
                                                                <input type="text" id="ADD2" name="ADD2" class="form-control" placeholder="OPH_ADD2" value="<?php echo $opp[0]['OPH_ADD2']; ?>"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label"></label>
                                                            <div class="col-md-8">
                                                                <input type="text" id="ADD3" name="ADD3" class="form-control" placeholder="OPH_ADD3" value="<?php echo $opp[0]['OPH_ADD3']; ?>"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label"></label>
                                                            <div class="col-md-8">
                                                                <input type="text" id="ADD4" name="ADD4" class="form-control" placeholder="OPH_ADD4" value="<?php echo $opp[0]['OPH_ADD4']; ?>"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
							    ...
							    <?php
								  ...
								  if(($opp[0]['OPH_CN_CODE'])==($row['CN_CODE'])){ ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <select class="form-control" id="ST_CODE"  name="ST_CODE">
                                                                  <!-- <option value="<?php //echo $opp[0]['OPH_ST_CODE']; ?>"><?php //echo $opp[0]['OPH_ST_CODE']; ?></option>  -->
								  <?php
							       if($state>0){
							       foreach($state  as $row){
								  if(($opp[0]['OPH_ST_CODE'])==($row['ST_CODE'])){ ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <select class="form-control"  id="CT_CODE" name="CT_CODE">
                                                                    <!--<option value="<?php //echo $opp[0]['OPH_CT_CODE']; ?>"><?php //echo $opp[0]['OPH_CT_CODE']; ?></option>-->
							<?php
							       if($city>0){
							       foreach($city  as $row){
								  if(($opp[0]['OPH_CT_CODE'])==($row['CT_CODE'])){ ?>
							   ...
							   <?php   }
								     ...
								     ?>
                                                    ...
                                                    <div class="col-md-6 ui-sortable"><!-- Second COL-6 BEGIN-->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="POSTAL" name="POSTAL" class="form-control" placeholder="OPH_POSTAL" value="<?php echo $opp[0]['OPH_POSTAL']; ?>"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label">Mobile</label>
                                                            <div class="col-md-8">
                                                                <input type="text" id="MOBILE" name="MOBILE" class="form-control" placeholder="OPH_MOBILE" value="<?php echo $opp[0]['OPH_MOBILE']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label">Phone</label>
                                                            <div class="col-md-8">
                                                                <input type="text" id="PHONE" name="PHONE" class="form-control" placeholder="OPH_PHONE" value="<?php echo $opp[0]['OPH_PHONE']; ?>"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="FAX" name="FAX" class="form-control" placeholder="OPH_FAX" value="<?php echo $opp[0]['OPH_FAX']; ?>"/>
                                                            </div>
                                                        </div>
                                                         <div class="form-group">
                                                            <label class="col-md-3 control-label">Email</label>
                                                            <div class="col-md-8">
                                                                <input type="text" id="EMAIL" name="EMAIL" class="form-control" placeholder="OPH_EMAIL" value="<?php echo $opp[0]['OPH_EMAIL']; ?>"/>
                                                            </div>
                                                        </div>
                                                        <!--<div class="form-group">
                                                            <label class="col-md-3 control-label">Contact Person</label>
                                                            <div class="col-md-8">
                                                                <input type="text" id="PERSON_NAME" name="PERSON_NAME" class="form-control" placeholder="OPH_PERSON_NAME" value="<?php //echo $opp[0]['OPH_CONTACT_PERSON']; ?>"/>
                                                            </div>
                                                        </div>-->
                                                    </div><!-- Second col 6 end-->
                                                </div><!--OUTER row defined end-->
                                                ...
                                                <div class="row form-horizontal"><!--OUTER row defined BEGIN-->
                                                    <div class="col-md-6 "><!-- FIRST COL-6 BEGIN-->  
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" placeholder="APPROX_AMT"  name="APPROX_AMT" id="APPROX_AMT" class="form-control" value="<?php echo $opp[0]['OPH_APPROX_AMT']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 "><!-- FIRST COL-6 BEGIN-->  
								...
								<?php
								  ...
								  if(($opp[0]['OPH_CCY_CODE'])==($row['CCY_CODE'])){ ?>
							...
							<div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" placeholder="OPH_CUST_AC_CODE"  name="CUST_AC_CODE" id="CUST_AC_CODE" class="form-control" value="<?php echo $opp[0]['OPH_CUST_AC_CODE']; ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" placeholder="OPH_CUST_AC_DESC"  name="CUST_AC_DESC" id="CUST_AC_DESC" class="form-control" value="<?php echo $opp[0]['OPH_CUST_AC_DESC']; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label">
                                                            ...
                                                            <div class="col-md-8">
                                                                <textarea rows="5" placeholder="DESC" name="DESC" id="DESC" class="form-control"><?php echo $opp[0]['OPH_DESC']; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div><!-- First col 6 end-->
								...
								<?php
								  ...
								  if(($opp[0]['OPH_STATUS'])==($row['VSL_CODE'])){ ?>
							   ...
							   <?php   }
								     ...
								     ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="checkbox">
                                                                    <label><input <?php if('Y'==( $opp[0]['OPH_SEND_LOGI_YN'])){
											    echo 'checked="checked"';
											    }else{
												//echo 'checked=""';
											    }
										    ?> name="SEND_LOGI_YN" id="SEND_LOGI_YN" type="checkbox">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input  type="text" class="form-control datepicker-dob" id="datetimepicker7" name="APPOINT_DT" value="<?php echo $opp[0]['OPH_APPOINT_DT']; ?>">
                                                            </div>
                                                        </div>
                                                    </div><!-- Second col 6 end-->
                                                </div><!--OUTER row defined end-->
						...
						<div class="col-md-5">
							...
							for($i=0;$i<$totdb;$i++){
								...
								if($prod[$i]==$code[$j]){
								   // break();
								 $not=$prod_code[$j]['IF_CODE'];
								// echo $prod_code[$j]['IF_CODE'];
								// echo $prod_code[$j]['IF_DESC'];
								    
								}else{
								    if($i==$totdb-1){
								    if($not != $code[$j]){ ?>
									<option value="<?php echo $prod_code[$j]['IF_CODE'];?>"><?php echo $prod_code[$j]['IF_DESC'];?></option>
								<?php }}
								}
					...
					<label class="col-md-1 control-label"></label>
						<div class="col-md-5">
							...
							<div class="form-group hidden">
                                                            ...
                                                            <div class="col-md-8">
								<input type="text" placeholder="OPH_COMP_CODE"  name="OPH_COMP_CODE" id="OPH_COMP_CODE" class="form-control" value="<?php echo $opp[0]['OPH_COMP_CODE']; ?>">
							    <input type="text" placeholder="OPH_SYS_ID"  name="OPH_SYS_ID" id="OPH_SYS_ID" class="form-control" value="<?php echo $opp[0]['OPH_SYS_ID']; ?>">
                                                            <input type="text" placeholder="OPH_LOCN_CODE"  name="OPH_LOCN_CODE" id="OPH_LOCN_CODE" class="form-control" value="<?php echo $opp[0]['OPH_LOCN_CODE']; ?>">
							    
							    <input type="text" placeholder="OPH_SR_CODE"  name="OPH_SR_CODE" id="OPH_SR_CODE" class="form-control" value="<?php echo $opp[0]['OPH_SR_CODE']; ?>">
							    <input type="text" placeholder="OPH_CUST_TYPE"  name="OPH_CUST_TYPE" id="OPH_CUST_TYPE" class="form-control" value="<?php echo $opp[0]['OPH_CUST_TYPE']; ?>">
							    <input type="text" placeholder="OPH_CUST_ID"  name="OPH_CUST_ID" id="OPH_CUST_ID" class="form-control" value="<?php echo $opp[0]['OPH_CUST_ID']; ?>">
							    <input type="text" placeholder="OPH_CLOSE_DT"  name="OPH_CLOSE_DT" id="OPH_CLOSE_DT" class="form-control" value="<?php echo $opp[0]['OPH_CLOSE_DT']; ?>">
							    <!--<input type="text" placeholder="OPH_APPOINT_DT"  name="OPH_APPOINT_DT" id="OPH_APPOINT_DT" class="form-control" value="<?php //echo $opp[0]['OPH_APPOINT_DT']; ?>">-->
							    <input type="text" placeholder="OPH_LOGI_JOB_STATUS"  name="OPH_LOGI_JOB_STATUS" id="OPH_LOGI_JOB_STATUS" class="form-control" value="<?php echo $opp[0]['OPH_LOGI_JOB_STATUS']; ?>">
							    <input type="text" placeholder="OPH_LANG_CODE"  name="OPH_LANG_CODE" id="OPH_LANG_CODE" class="form-control" value="<?php echo $opp[0]['OPH_LANG_CODE']; ?>">
							    <!--<input type="hidden" id="OPH_SR_CODE"  name="OPH_SR_CODE" value="<?php //echo $opp[0]['OPH_APPOINT_DT']; ?>"  />-->
							    <!--<input type="hidden" name="OPH_LOCN_CODE" id="OPH_LOCN_CODE" value="<?php //echo $opp[0]['OPH_APPOINT_DT']; ?>">-->
								     ...
								     ?>
                                                    ...
                                                    <div class="col-md-6 ui-sortable"><!-- Second COL-6 BEGIN-->
                                                        ...
                                                        <!--<div class="form-group">
                                                            <label class="col-md-3 control-label">Contact Person</label>
                                                            <div class="col-md-8">
                                                                <input type="text" id="OPH_PERSON_NAME" name="OPH_PERSON_NAME" class="form-control" placeholder="OPH_PERSON_NAME" />
                                                            </div>
                                                        </div>-->
                                                    </div><!-- Second col 6 end-->
                                                </div><!--OUTER row defined end-->
								...
								<?php }?>
                                                ...
                                                <div class="col-md-offset-2 pager form-group"><!--footer start-->
                                                    <div class="col-md-12 control-label">
                                                       ...
                                                       <button  class="opp_save btn btn-primary m-r-5 m-b-5 " type="submit"  name="update" id="update" value="Update">Update</button>
                                            ...
                                            <div class="row well">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group col-md-10">
                                                            ...
                                                            <input type="text" name="OPH_TXN_CODE" placeholder="OPH_TXN_CODE" class="form-control" value="<?php echo $opp[0]['OPH_TXN_CODE']; ?>"/>
                                                    </div>
                                                </div>
                                                <!-- end col-4 -->
                                                <!-- begin col-4 -->
                                                <div class="col-md-4">
                                                    <div class="form-group col-md-10">
                                                            ...
                                                            <input type="text" name="OPH_TXN_NO" placeholder="OPH_TXN_NO" class="form-control" value="<?php echo $opp[0]['OPH_TXN_NO']; ?>" />
                                                    </div>
                                                </div>
                                                <!-- end col-4 -->
                                                <!-- begin col-4 -->
...
$(document).ready(function() {
  ...
  //daysOfWeekDisabled: [0,6],
   minDate:nexdate
    ...
    //$("#datetimepicker_current_opl").datepicker().datepicker("setDate", new Date());
    
    //$('#datetimepicker_current_opl').datetimepicker({
    //format: 'DD-MMM-YY'
    //     });
	...
	window.location.replace("<?php echo base_url();?>Sales/OpportunityTransactionView");
...
$(document).ready(function() {
    ...
    //$(document).on('blur','#CONTACT_NO,#second,#CONTACT_PERSON,#OPPORTUNITY,#ADD1,#ADD2,#ADD3,#ADD4,#CN_CODE,#ST_CODE,#CT_CODE,#POSTAL,#MOBILE,#PHONE,#FAX,#EMAIL,#PERSON_NAME,#APPROX_AMT,#CCY_CODE,#CUST_ACC_CODE,#CUST_ACC_DESC,#DESC,#STATUS,#SEND_LOGI_YN,#datetimepicker7',function(event){
	//$(document).on('click','#one,#two,#three,#four,#five',function(event){
...
//           document.getElementById('OPH_PERSON_NAME').value=person;
