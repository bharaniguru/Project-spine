...
<div class="content" id="content">
			...
			<li><a href="javascript:;">Edit</a></li>
                     ...
                     <!-- end breadcrumb -->
                     <!-- begin page-header -->
                     <h1 class="page-header">Customer Master <small> You may edit here... </small></h1>
                     <!-- end page-header -->
             ...
             <!-- begin  -->
                    ...
                    <div data-sortable-id="form-stuff-1" class="panel panel-inverse">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                             ...
                             <h4 class="panel-title">Customer Master Edit</h4>
                        </div>
                     
                        <div class="panel-body">
			    <p style="color: #EB4688"><?php if (isset($error_message)) { echo $error_message; } ?></p>
                            <form class="form-horizontal" name="myForm" id="myForm" action="<?php echo base_url();?>Sales/CustomerMaster_Edit" method="post" enctype="multipart/form-data">
                                <div class="well"><!--well start-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" id="CUST_COMP_CODE" name="CUST_COMP_CODE" placeholder="CUST_COMP_CODE" type="text" value="<?php echo $cust_master[0]['CUST_COMP_CODE'];?>">
                                        </div>
                                    </div>
				...
				<div class="row hidden">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" id="CUST_LANG_CODE" name="CUST_LANG_CODE" placeholder="CUST_LANG_CODE" type="text" value="<?php echo $cust_master[0]['CUST_LANG_CODE'];?>">
                                        </div>
                                    </div>
                                </div><!--Inner row hidden END-->
					...
					<?php
						...
						if(($cust_master[0]['CUST_PARTY_TYPE'])==($row['VSL_CODE'])){
					...
					?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="CUST_PARTY_DESC" name="CUST_PARTY_DESC" class="form-control" placeholder="CUST_PARTY_DESC" value="<?php echo $cust_master[0]['CUST_PARTY_DESC'];?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Alias</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="CUST_PARTY_ALIAS" name="CUST_PARTY_ALIAS" class="form-control" placeholder="CUST_PARTY_ALIAS" value="<?php echo $cust_master[0]['CUST_PARTY_ALIAS'];?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">URL</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="CUST_PARTY_URL" name="CUST_PARTY_URL" class="form-control" placeholder="CUST_PARTY_URL" value="<?php echo $cust_master[0]['CUST_PARTY_URL'];?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <option disabled="" selected="" value="0">Select</option>
						<?php
					    foreach($ac_type  as $row){
						if(($cust_master[0]['CUST_AC_TYPE'])==($row['VSL_CODE'])){
					?>		<option selected="selected" value="<?php echo $row['VSL_CODE'];?>"><?php echo $row['VSL_DESC'];?></option>
					<?php   }
						    if(($cust_master[0]['CUST_AC_TYPE'])!=($row['VSL_CODE'])){?>
						       <option value="<?php echo $row['VSL_CODE'];?>"><?php echo $row['VSL_DESC'];?></option>
					...
					?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" readonly id="CUST_AC_CODE" name="CUST_AC_CODE" class="form-control" placeholder="CUST_AC_CODE" value="<?php echo $cust_master[0]['CUST_AC_CODE'];?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Description</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="CUST_AC_DESC" name="CUST_AC_DESC" class="form-control" placeholder="CUST_AC_DESC" value="<?php echo $cust_master[0]['CUST_AC_DESC'];?>" />
                                                </div>
                                            </div> 
                                        ...
                                        <div class="col-md-5 ui-sortable"><!-- SECOND COL-6 BEGIN-->
                                            <div class="col-md-offset-4 col-md-9">
                                                <div class="form-group">
                                                    <div class="checkbox">
                                                    <label>
                                                    <input type="checkbox" <?php if('Y'==( $cust_master[0]['CUST_ACTIVE_YN'])){
											    echo 'checked="checked"';
											    }else{
												//echo 'checked=""';
											    }
										    ?> name="CUST_ACTIVE_YN" id="CUST_ACTIVE_YN">
                                                            Active?
                                                    </label>
                                                    </div>
                                                </div>
                                                ...
                                                <label class="col-md-3 control-label">Title</label>
                                                    <div class="col-md-9">
                                                        <select class="form-control" id="CUST_PERSON_TITLE" name="CUST_PERSON_TITLE">
                                                             <option disabled="" selected="" value="0">Select</option>
                                                    <?php
					    foreach($cust_title  as $row){
						if(($cust_master[0]['CUST_PERSON_TITLE'])==($row['VSL_CODE'])){
					?>		<option selected="selected" value="<?php echo $row['VSL_CODE'];?>"><?php echo $row['VSL_DESC'];?></option>
					<?php   }
						    if(($cust_master[0]['CUST_PERSON_TITLE'])!=($row['VSL_CODE'])){?>
						       <option value="<?php echo $row['VSL_CODE'];?>"><?php echo $row['VSL_DESC'];?></option>
					...
					?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="CUST_PERSON_FIRST_NAME" name="CUST_PERSON_FIRST_NAME" class="form-control" placeholder="CUST_PERSON_FIRST_NAME" value="<?php echo $cust_master[0]['CUST_PERSON_FIRST_NAME'];?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Middle Name</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="CUST_PERSON_MIDDLE_NAME" name="CUST_PERSON_MIDDLE_NAME" class="form-control" placeholder="CUST_PERSON_MIDDLE_NAME" value="<?php echo $cust_master[0]['CUST_PERSON_MIDDLE_NAME'];?>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Last Name</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="CUST_PERSON_LAST_NAME" name="CUST_PERSON_LAST_NAME" class="form-control" placeholder="CUST_PERSON_LAST_NAME" value="<?php echo $cust_master[0]['CUST_PERSON_LAST_NAME'];?>"/>
                                                </div>
                                            </div>
                ...
                <div class="well"><!--tab started-->
                    ...
                    <div class="tab-content">
                        <div id="nav-tab-1" class="tab-pane fade active in">
                                ...
                                <div class="col-md-6 ui-sortable ">
                                    <div class="row"> <!-- FIRST COL-6 BEGIN-->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="CUST_SITE_ADD1" name="CUST_SITE_ADD1" class="form-control" placeholder="CUST_SITE_ADD1" value="<?php echo $cust_master[0]['CUST_SITE_ADD1'];?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row"> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="CUST_SITE_ADD2" name="CUST_SITE_ADD2" class="form-control" placeholder="CUST_SITE_ADD2" value="<?php echo $cust_master[0]['CUST_SITE_ADD2'];?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row"> 
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"></label>
                                            <div class="col-md-9">
                                                <input type="text" id="CUST_SITE_ADD3" name="CUST_SITE_ADD3" class="form-control" placeholder="CUST_SITE_ADD3" value="<?php echo $cust_master[0]['CUST_SITE_ADD3'];?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row"> 
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"></label>
                                            <div class="col-md-9">
                                                <input type="text" id="CUST_SITE_ADD4" name="CUST_SITE_ADD4" class="form-control" placeholder="CUST_SITE_ADD4" value="<?php echo $cust_master[0]['CUST_SITE_ADD4'];?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row"> 
							...
							if(($cust_master[0]['CUST_SITE_CN_CODE'])==($row['CN_CODE'])){
						?>		<option selected="selected" value="<?php echo $row['CN_CODE'];?>"><?php echo $row['CN_DESC'];?></option>
						<?php   }
							    if(($cust_master[0]['CUST_SITE_CN_CODE'])!=($row['CN_CODE'])){?>
						...
						?>
								  ...
								  if(($cust_master[0]['CUST_SITE_ST_CODE'])==($row['ST_CODE'])){ ?>
								       <option selected="selected" value="<?php echo $row['ST_CODE'];?>"><?php echo $row['ST_DESC'];?></option>
							   <?php   }
								       if(($cust_master[0]['CUST_SITE_ST_CODE'])!=($row['ST_CODE'])){?>
							       ...
							       if($city>0){
							       foreach($city  as $row){
								  if(($cust_master[0]['CUST_SITE_CT_CODE'])==($row['CT_CODE'])){ ?>
								       <option selected="selected" value="<?php echo $row['CT_CODE'];?>"><?php echo $row['CT_DESC'];?></option>
							   <?php   }
								       if(($cust_master[0]['CUST_SITE_CT_CODE'])!=($row['CT_CODE'])){?>
				...
				<div class="col-md-9">
				    <input type="text" id="CUST_SITE_POSTAL" name="CUST_SITE_POSTAL" class="form-control" placeholder="CUST_SITE_POSTAL" value="<?php echo $cust_master[0]['CUST_SITE_POSTAL'];?>"/>
				</div>
                            </div>
                            </div>
                            <div class="row"> 
				...
				<div class="col-md-9">
				    <input type="text" id="CUST_SITE_MOBILE" name="CUST_SITE_MOBILE" class="form-control" placeholder="CUST_SITE_MOBILE" value="<?php echo $cust_master[0]['CUST_SITE_MOBILE'];?>"/>
				</div>
                            </div>
                            </div>
                            <div class="row"> 
				...
				<div class="col-md-9">
				    <input type="text" id="CUST_SITE_PHONE" name="CUST_SITE_PHONE" class="form-control" placeholder="CUST_SITE_PHONE" value="<?php echo $cust_master[0]['CUST_SITE_PHONE'];?>"/>
				</div>
                            </div></div>
                            <div class="row"> 
                            <div class="form-group">
				...
				<div class="col-md-9">
				    <input type="text" id="CUST_SITE_FAX" name="CUST_SITE_FAX" class="form-control" placeholder="CUST_SITE_FAX" value="<?php echo $cust_master[0]['CUST_SITE_FAX'];?>"/>
				</div>
                            </div>
                            </div>
                            <div class="row"> 
				...
				<div class="col-md-9">
				    <input type="text" id="CUST_SITE_EMAIL" name="CUST_SITE_EMAIL" class="form-control" placeholder="CUST_SITE_EMAIL" value="<?php echo $cust_master[0]['CUST_SITE_EMAIL'];?>"/>
				</div>
                            </div>
                            </div>
                            <div class="row"> 
				...
				<div class="col-md-9">
				    <input type="text" id="CUST_SITE_PERSON_NAME" name="CUST_SITE_PERSON_NAME" class="form-control" placeholder="CUST_SITE_PERSON_NAME" value="<?php echo $cust_master[0]['CUST_SITE_PERSON_NAME'];?>" />
				</div>
                            </div>
                            </div>
                        </div><!-- FIRST COL-6 End-->
				...
				<div class="col-md-9">
				    <input type="text" id="CUST_BILL_ADD1" name="CUST_BILL_ADD1" class="form-control" placeholder="CUST_BILL_ADD1" value="<?php echo $cust_master[0]['CUST_BILL_ADD1'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label"></label>
				<div class="col-md-9">
				    <input type="text" id="CUST_BILL_ADD2" name="CUST_BILL_ADD2" class="form-control" placeholder="CUST_BILL_ADD2" value="<?php echo $cust_master[0]['CUST_BILL_ADD2'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label"></label>
				<div class="col-md-9">
				    <input type="text" id="CUST_BILL_ADD3" name="CUST_BILL_ADD3" class="form-control" placeholder="CUST_BILL_ADD3" value="<?php echo $cust_master[0]['CUST_BILL_ADD3'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label"></label>
				<div class="col-md-9">
				    <input type="text" id="CUST_BILL_ADD4" name="CUST_BILL_ADD4" class="form-control" placeholder="CUST_BILL_ADD4" value="<?php echo $cust_master[0]['CUST_BILL_ADD4'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<div class="col-md-9">
					...
					<option value="0">Select Country</option>
					 <?php if (count($country) > 0 )
                                                  {
						    foreach($country  as $row){
							if(($cust_master[0]['CUST_BILL_CN_CODE'])==($row['CN_CODE'])){
						?>		<option selected="selected" value="<?php echo $row['CN_CODE'];?>"><?php echo $row['CN_DESC'];?></option>
						<?php   }
							    if(($cust_master[0]['CUST_BILL_CN_CODE'])!=($row['CN_CODE'])){?>
							       <option value="<?php echo $row['CN_CODE'];?>"><?php echo $row['CN_DESC'];?></option>
				...
				<div class="col-md-9">
					...
					<?php
					    if($state_bill>0){
					    foreach($state_bill  as $row){
					       if(($cust_master[0]['CUST_BILL_ST_CODE'])==($row['ST_CODE'])){ ?>
						    <option selected="selected" value="<?php echo $row['ST_CODE'];?>"><?php echo $row['ST_DESC'];?></option>
					<?php   }
						    if(($cust_master[0]['CUST_BILL_ST_CODE'])!=($row['ST_CODE'])){?>
						       <option value="<?php echo $row['ST_CODE'];?>"><?php echo $row['ST_DESC'];?></option>
				...
				<div class="col-md-9">
					...
					<option value="0">Select City</option>
					 <?php
					    if($city_bill>0){
					    foreach($city_bill  as $row){
					       if(($cust_master[0]['CUST_BILL_CT_CODE'])==($row['CT_CODE'])){ ?>
						    <option selected="selected" value="<?php echo $row['CT_CODE'];?>"><?php echo $row['CT_DESC'];?></option>
					<?php   }
						    if(($cust_master[0]['CUST_BILL_CT_CODE'])!=($row['CT_CODE'])){?>
						       <option value="<?php echo $row['CT_CODE'];?>"><?php echo $row['CT_DESC'];?></option>
				...
				<label class="col-md-3 control-label">PO Box</label>
				<div class="col-md-9">
				    <input type="text" id="CUST_BILL_POSTAL" name="CUST_BILL_POSTAL" class="form-control" placeholder="CUST_BILL_POSTAL" value="<?php echo $cust_master[0]['CUST_BILL_POSTAL'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label">Mobile</label>
				<div class="col-md-9">
				    <input type="text" id="CUST_BILL_MOBILE" name="CUST_BILL_MOBILE" class="form-control" placeholder="CUST_BILL_MOBILE" value="<?php echo $cust_master[0]['CUST_BILL_MOBILE'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label">Phone</label>
				<div class="col-md-9">
				    <input type="text" id="CUST_BILL_PHONE" name="CUST_BILL_PHONE" class="form-control" placeholder="CUST_BILL_PHONE" value="<?php echo $cust_master[0]['CUST_BILL_PHONE'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label">Fax</label>
				<div class="col-md-9">
				    <input type="text" id="CUST_BILL_FAX" name="CUST_BILL_FAX" class="form-control" placeholder="CUST_BILL_FAX" value="<?php echo $cust_master[0]['CUST_BILL_FAX'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label">Email</label>
				<div class="col-md-9">
				    <input type="text" id="CUST_BILL_EMAIL" name="CUST_BILL_EMAIL" class="form-control" placeholder="CUST_BILL_EMAIL" value="<?php echo $cust_master[0]['CUST_BILL_EMAIL'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label">Contact Person</label>
				<div class="col-md-9">
				    <input type="text" id="CUST_BILL_PERSON_NAME" name="CUST_BILL_PERSON_NAME" class="form-control" placeholder="CUST_BILL_PERSON_NAME" value="<?php echo $cust_master[0]['CUST_BILL_PERSON_NAME'];?>"/>
				</div>
                            </div>
                            </div>
						    ...
						    <?php
					    foreach($cc  as $row){
						if(($cust_master[0]['CUST_CLASS_CODE'])==($row['CC_CODE'])){
					?>		<option selected="selected" value="<?php echo $row['CC_CODE'];?>"><?php echo $row['CC_DESC'];?></option>
					<?php   }
						    if(($cust_master[0]['CUST_CLASS_CODE'])!=($row['CC_CODE'])){?>
				...
				<div class="col-md-9">
				    <select class="form-control" id="CUST_EXCHG_RATE_CODE" name="CUST_EXCHG_RATE_CODE">
					 ...
					 <?php
					    foreach($exch  as $row){
						if(($cust_master[0]['CUST_EXCHG_RATE_CODE'])==($row->VSL_CODE)){
					?>		<option selected="selected" value="<?php echo $row->VSL_CODE;?>"><?php echo $row->VSL_DESC;?></option>
					<?php   }
						    if(($cust_master[0]['CUST_EXCHG_RATE_CODE'])!=($row->VSL_CODE)){?>
						       <option value="<?php echo $row->VSL_CODE;?>"><?php echo $row->VSL_DESC;?></option>
				...
				<div class="col-md-9">
					...
					<?php
                                            if(count($ccy)>0){
                                            foreach($ccy  as $row){
                                               if(($cust_master[0]['CUST_CCY_CODE'])==($row->CCY_CODE)){ ?>
                                                    <option selected="selected" value="<?php echo  $row->CCY_CODE;?>"><?php echo $row->CCY_DESC; ?></option>
                                        <?php   }
                                                    if(($cust_master[0]['CUST_CCY_CODE'])!=($row->CCY_CODE)){?>
				...
				<div class="col-md-9">
				    <select class="form-control" id="CUST_PAY_TERM_CODE" name="CUST_PAY_TERM_CODE">
					 ...
					 <?php
                                            if(count($pay)>0){
                                            foreach($pay  as $row){
                                               if(($cust_master[0]['CUST_PAY_TERM_CODE'])==($row->PT_CODE)){ ?>
                                                    <option selected="selected" value="<?php echo $row->PT_CODE;?>"><?php echo $row->PT_DESC; ?></option>
                                        <?php   }
                                                    if(($cust_master[0]['CUST_PAY_TERM_CODE'])!=($row->PT_CODE)){?>
						...
						<?php
                                            ...
                                            foreach($ac_mang  as $row){
                                               if(($cust_master[0]['CUST_AC_MANAGER'])==($row['SR_CODE'])){ ?>
						...
						<?php
                                            ...
                                            foreach($sp_code  as $row){
                                               if(($cust_master[0]['CUST_SR_CODE'])==($row['SR_CODE'])){ ?>
                                                    <option selected="selected" value="<?php echo $row['SR_CODE'];?>"><?php echo $row['SR_FIRST_NAME']; ?></option>
                                        <?php   }
                                                    if(($cust_master[0]['CUST_SR_CODE'])!=($row['SR_CODE'])){?>
                                                       <option value="<?php echo $row['SR_CODE'];?>"><?php echo $row['SR_FIRST_NAME'];?></option>
						...
						<?php
                                            ...
                                            foreach($cycle  as $row){
                                               if(($cust_master[0]['CUST_STMT_CYCLE_CODE'])==($row->VSL_CODE)){ ?>
                                                    <option selected="selected" value="<?php echo $row->VSL_CODE;?>"><?php echo $row->VSL_DESC; ?></option>
                                        <?php   }
                                                    if(($cust_master[0]['CUST_STMT_CYCLE_CODE'])!=($row->VSL_CODE)){?>
                                                       <option value="<?php echo $row->VSL_CODE;?>"><?php echo $row->VSL_DESC;?></option>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="CUST_CREDIT_LIMIT" name="CUST_CREDIT_LIMIT" class="form-control" placeholder="CUST_CREDIT_LIMIT" value="<?php echo $cust_master[0]['CUST_CREDIT_LIMIT'];?>" />
                                        </div>
                                </div>
                                <div class="form-group">
                                        <label class="col-md-3 control-label">Discount Grace Days</label>
                                        <div class="col-md-9">
                                            <input type="text" id="CUST_DISC_GRACE_DAYS" name="CUST_DISC_GRACE_DAYS" class="form-control" placeholder="CUST_DISC_GRACE_DAYS" value="<?php echo $cust_master[0]['CUST_DISC_GRACE_DAYS'];?>"/>
                                </div>
                            </div>
                        <br>
                        <br>
			   ...
			   <label class="col-md-3 control-label">From Date</label>
					...
					<input type="text" placeholder="Date Start" name="CUST_FROM_DT" id="datetimepicker6" class="form-control"  value="<?php echo $cust_master[0]['CUST_FROM_DT'];?>">
					    <span class="input-group-addon"> Upto Date</span>
					<input type="text" placeholder="Date End" name="CUST_UPTO_DT" id="datetimepicker7" class="form-control" value="<?php echo $cust_master[0]['CUST_UPTO_DT'];?>">
				    </div>
				</div>
		       </div>
                        ...
                        <div class="col-md-6 ui-sortable "><!-- Second COL-6 BEGIN-->
                                   ...
                                   <!-- <div class="col-md-offset-2 col-md-9">
                                    ...
                                    <div class="col-md-offset-2 col-md-9">
                                        <div class="form-group">
                                            <div class="checkbox">
                                                    <label><input type="checkbox" <?php if('Y'==( $cust_master[0]['CUST_SEND_DUNNING_YN'])){
											    echo 'checked="checked"';
											    }else{
												//echo 'checked=""';
											    }
										    ?> id="CUST_SEND_DUNNING_YN" name="CUST_SEND_DUNNING_YN">
                                                        Send Dunning ?
                                                    </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-offset-2 col-md-9">
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <label><input type="checkbox"  <?php if('Y'==( $cust_master[0]['CUST_SEND_STMT_YN'])){
											    echo 'checked="checked"';
											    }else{
												//echo 'checked=""';
											    }
										    ?>   id="CUST_SEND_STMT_YN" name="CUST_SEND_STMT_YN">
                                                   Send Statement ?
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-offset-2 col-md-9">
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <label><input type="checkbox"  <?php if('Y'==( $cust_master[0]['CUST_CREDIT_CHECK_YN'])){
											    echo 'checked="checked"';
											    }else{
												//echo 'checked=""';
											    }
										    ?>  id="CUST_CREDIT_CHECK_YN" name="CUST_CREDIT_CHECK_YN">
                                                   Allow Credit ?
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-offset-2 col-md-9">
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <label><input type="checkbox"  <?php if('Y'==( $cust_master[0]['CUST_DISC_YN'])){
											    echo 'checked="checked"';
											    }else{
												//echo 'checked=""';
											    }
										    ?>  id="CUST_DISC_YN" name="CUST_DISC_YN">
                                                   Allow Discount ?
                                                </label>
                                            </div>
                                        </div>
				...
				?>
                                <tr class="odd">
                                    <td>
                                        <input type="text" id="CCONT_NAME" name="CCONT_NAME[]" readonly placeholder="CCONT_NAME" value="<?php echo $cust_contact[$i]['CCONT_NAME'];?>"/>
                                    </td>
                                    <td>
                                        <input type="text" id="CCONT_MOBILE" name="CCONT_MOBILE[]"  placeholder="CCONT_MOBILE"  value="<?php echo $cust_contact[$i]['CCONT_MOBILE'];?>"/>
                                    </td>
                                    <td>
                                        <input type="text" id="CCONT_PHONE" name="CCONT_PHONE[]"  placeholder="CCONT_PHONE"  value="<?php echo $cust_contact[$i]['CCONT_PHONE'];?>"/>
                                    </td>
                                    <td>
                                        <input type="text" id="CCONT_EMAIL" name="CCONT_EMAIL[]"  placeholder="CCONT_EMAIL"  value="<?php echo $cust_contact[$i]['CCONT_EMAIL'];?>"/>
                                    </td>
                                    <td>
                                        <input type="text" id="CCONT_LINKEDIN" name="CCONT_LINKEDIN[]"  placeholder="CCONT_LINKEDIN"  value="<?php echo $cust_contact[$i]['CCONT_LINKEDIN'];?>"/>
                                    </td>
                                    <td>
                                        <input type="text" id="CCONT_FACEBOOK" name="CCONT_FACEBOOK[]"  placeholder="CCONT_FACEBOOK"  value="<?php echo $cust_contact[$i]['CCONT_FACEBOOK'];?>"/>
                                    </td>
                                    <td>
                                        <input type="text" id="CCONT_TWITTER" name="CCONT_TWITTER[]"  placeholder="CCONT_TWITTER"  value="<?php echo $cust_contact[$i]['CCONT_TWITTER'];?>"/>
                                    </td>
                                    <td>
                                        <div class="input-group input-daterange">
					<input type="text" placeholder="Date Start" name="CCONT_FROM_DT[]" id="datetimepicker8"  value="<?php echo $cust_contact[$i]['CCONT_FROM_DT'];?>" >
					    <span class="input-group-addon"> Upto Date</span>
					<input type="text" placeholder="Date End" name="CCONT_UPTO_DT[]" id="datetimepicker9"  value="<?php echo $cust_contact[$i]['CCONT_UPTO_DT'];?>">
				    </div>
                                    </td>
                                    <td>
                                        <input type="checkbox" <?php if('Y'==( $cust_contact[$i]['CCONT_ACTIVE_YN'])){
											    echo 'checked="checked"';
											    }else{
												//echo 'checked=""';
											    }
										    ?> id="CCONT_ACTIVE_YN" name="CCONT_ACTIVE_YN[]"  />
                                    </td>
                                    <td><a href="<?php echo base_url(); ?>sales/CustomerMasterContactDelete_One_Row/<?php echo $cust_contact[$i]['CCONT_AC_CODE'];?>/<?php echo $cust_contact[$i]['CCONT_NAME'];?>/<?php echo $cust_contact[$i]['CCONT_COMP_CODE'];?>"><button type="button" class="btn btn-remove btn-danger btn-sm removeButton" data-template="textbox">Remove</button></a></td>
                                    <!--<td>
                ...
                <div id="nav-tab-4" class="tab-pane fade">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">From Date</label>
                                                 <div class="col-md-9">
                                                     <div class="input-group input-daterange">
                                                         <input type="text" placeholder="Date Start" name="CDOC_FROM_DT" id="datetimepicker10" class="form-control" value="<?php echo $cust_doc[0]['CDOC_FROM_DT'];?>" >
                                                             <span class="input-group-addon"> Upto Date</span>
                                                         <input type="text" placeholder="Date End" name="CDOC_UPTO_DT" id="datetimepicker11" class="form-control" value="<?php echo $cust_doc[0]['CDOC_UPTO_DT'];?>">
                                                     </div>
                                                 </div>
                                        </div>    
                                    </div>
                                ...
                                <thead>
                                    <tr class="odd info">
                                        ...
                                        <th>Active (<i class="fa fa-1x fa-check"></i>)</th>
					<th> <button type="button" class="btn btn-add2 btn-sm btn-primary" data-template="textbox">Add</button></th>
                                    </tr>
                                    
                                </thead>
                                <tbody>
				    <?php
					  $count=count($cust_doc);  
					for($i=0;$i<$count;$i++){
				    
				?>
                                    <tr>
                                        <td>
                                            <input type="text" id="CDOC_SR_NO" name="CDOC_SR_NO[]" readonly placeholder="CDOC_SR_NO" value="<?php echo $cust_doc[$i]['CDOC_SR_NO'];?>"/>
                                        </td>
                                        <td>
                                        <input type="file" id="CDOC_FILE_NAME" name="CDOC_FILE_NAME[]" class="btn btn-success"  placeholder="CDOC_FILE_NAME" value="<?php echo $cust_doc[$i]['CDOC_FILE_NAME'];?>"/>
					<input type="hidden" name="old_file_name[]" value="<?php echo $cust_doc[$i]['CDOC_FILE_NAME'];?>">
					<input type="hidden" name="old_file_size[]" value="<?php echo $cust_doc[$i]['CDOC_SIZE'];?>">
                                        </td>
                                        <td>
                                            <input type="text" id="CDOC_DESC" name="CDOC_DESC[]"  placeholder="CDOC_DESC" value="<?php echo $cust_doc[$i]['CDOC_DESC'];?>"/>
                                        </td>
					<td>
                                        <div class="input-group input-daterange">
					<input type="text" placeholder="Date Start" name="CDOC_FROM_DT[]" id="datetimepicker10"  value="<?php echo $cust_doc[$i]['CDOC_FROM_DT'];?>" >
					    <span class="input-group-addon"> Upto Date</span>
					<input type="text" placeholder="Date End" name="CDOC_UPTO_DT[]" id="datetimepicker11" value="<?php echo $cust_doc[$i]['CDOC_UPTO_DT'];?>" >
                                        </div>
                                        </td>
                                        <td>
                                           <input type="checkbox" <?php if('Y'==( $cust_doc[$i]['CDOC_ACTIVE_YN'])){
											    echo 'checked="checked"';
											    }else{
												//echo 'checked=""';
											    }
										    ?> id="CDOC_ACTIVE_YN" name="CDOC_ACTIVE_YN[]"  />
                                        </td>
                                       <td><a href="<?php echo base_url(); ?>sales/CustomerMasterDocDelete_One_Row/<?php echo $cust_doc[$i]['CDOC_AC_CODE'];?>/<?php echo $cust_doc[$i]['CDOC_SR_NO'];?>/<?php echo $cust_doc[$i]['CDOC_COMP_CODE'];?>"><button type="button" class="btn btn-remove2 btn-danger btn-sm removeButton" data-template="textbox">Remove</button></a></td>
                                         <!--<td>
					...
					<input type="hidden" name="old_file_size[]">
                                        </td>
                                        <td>
	...
	success: function(json) {
		...
		if (json.exist_cust!="") {
		   // alert("Existing Customer");
		    ...
		    //document.getElementById("CUST_DISC_YN").value=json[0].CC_DISC_YN;
		    ...
		    //document.getElementById("CUST_SEND_STMT_YN").value=json[0].CC_SEND_STMT_YN;
		    ...
		    //document.getElementById("CUST_SEND_DUNNING_YN").value=json[0].CC_SEND_DUNNING_YN;
		    ...
		    document.getElementById("CUST_SR_CODE").value=json[0].CC_SP_CODE;
                    //var active=json[0].CC_ACTIVE_YN;
                    //if (active=='Y')
                    //{
                    //    document.getElementById('CUST_ACTIVE_YN').checked=true;
                    //}
                    //else
                    //{
                    //    document.getElementById('CUST_ACTIVE_YN').checked=false;
                    //        
                    //}
		   // document.getElementById("CUST_ACTIVE_YN").value=json[0].CC_ACTIVE_YN;
