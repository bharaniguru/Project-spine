...
<div id="content" class="content">
	...
	<li class="active">Add Material Issue Transaction</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Add Material Issue Transaction <small> Enter the correct details here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Add Material Issue Transaction</h4>
		</div>
		<div class="panel-body">
                        <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo site_url('InventoryController/MaterialIssueTransaction_Add');?>" class="form-horizontal">
			    <div class="row">
			    <label class="col-md-1 control-label">Transaction Code</label>
			    <div class="col-md-2">
				<input type="text" placeholder="TXN_CODE" name="mih_txn_code" value="MIS" class="form-control" readonly>
                            </div>
			    <label class="col-md-1 control-label">Transaction Type</label>
			    <div class="col-md-2">
				<input type="text" name="mih_txn_type" placeholder="MIH_TXN_TYPE" id="mih_txn_type" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Txn Number</label>
			    <div class="col-md-2">
				<input type="text" value="<?php echo $result['return_status']?>" name="mih_txn_no" placeholder="MIH_TXN_NO" id="mih_txn_no" class="form-control" readonly>
			    </div>
			   <label class="col-md-1 control-label">Txn Date</label>
			   <div class="col-md-2">
				<input type="text" name="mih_txn_dt" placeholder="MIH_TXN_DT" id="datepicker" class="form-control" value="<?php echo date('d-M-y');?>">
			    </div>
                           </div>
			     <div class="row p-t-20">
			    <label class="col-md-1 control-label">Description</label>
			    <div class="col-md-2">
				<input type="text" name="mih_desc" id="mih_desc" placeholder="MIH_DESC" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Center Code</label>
			    <div class="col-md-2">
				<input type="text" name="mih_center_code" placeholder="MIH_STATUS" id="mih_center_code" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Status</label>
			    <div class="col-md-2">
				<input type="text" name="mih_status" placeholder="MIH_STATUS" id="mih_status" class="form-control">
			    </div>
				    ...
				    <div class="modal-dialog">
						...
						<!--<label class="col-md-1 control-label"></label>-->
								...
								<div class="col-md-5">
								    ...
								    <!--<label class="btn">
									<button type="button" class="btn btn-sm btn-danger" onclick="listbox_selectall('first','second', false)">Unselect</button>
								    </label>-->
								    <label class="btn">
									<button type="button" id="clear" class="btn btn-sm btn-danger" >Clear</button>
								    </label>
								    <!--<label class="btn">
									<button type="button" id="reset" class="btn btn-sm btn-danger" >Reset</button>
								    </label>-->
								</div>
			    ...
			    <div class="col-md-2">
				<input type="text" name="mih_delv_loc" id="mih_delv_loc" placeholder="MIH_PERSON_COD" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Source Loc</label>
			    <div class="col-md-2">
				<input type="text" name="mih_src_loc" placeholder="MIH_SRC_LOC" id="mih_src_loc" class="form-control">
			    </div>
			    </div> 
...
$.ajax({
type:"POST",
url:"<?php  echo site_url('InventoryController/AjaxMatIssueLine')?>",
data:{code:sys_code},
