...
<div id="content" class="content">
	...
	<li class="active">Edit Stock Transfer Incoming</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Stock Transfer Incoming <small> Enter the correct details here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Edit Stock Transfer Incoming</h4>
		</div>
		<div class="panel-body">
                        <form id="	" method="POST" enctype="multipart/form-data" action="<?php echo site_url('InventoryController/StockTransferIncoming_Edit/'.$result[0]['STIH_SYS_ID']);?>" class="form-horizontal">
			    <div class="row">
			    <label class="col-md-1 control-label">Transaction</label>
			    <div class="col-md-2">
				<div class="input-group">
				    <input type="text" readonly=""value="<?php echo $result[0]['STIH_TXN_CODE']?>" placeholder="STIH_TXN_CODE" name="STIH_TXN_CODE" class="form-control">
				    <input type="hidden"value="<?php echo $result[0]['STIH_SYS_ID']?>" placeholder="STIH_SYS_ID" name="STIH_SYS_ID" class="form-control">
			    ...
			    <div class="col-md-2">
				<input type="text" value="<?php echo $result[0]['STIH_TXN_NO']?>"readonly="" name="STIH_TXN_NO1" placeholder="STIH_TXN_NO" value="<?php echo $result['return_status']?>"id="mih_doc_no" class="form-control">
			    </div>
			   <label class="col-md-1 control-label">Doc Date</label>
			   <div class="col-md-2">
				<input type="text"value="<?php echo $result[0]['STIH_TXN_DT']?>" name="STIH_TXN_DT" placeholder="STIH_TXN_DT" id="STIH_TXN_DT" class="form-control">
			    </div>
                           </div>
			     <div class="row p-t-20">
			    <label class="col-md-1 control-label">Description</label>
			    <div class="col-md-5">
				<input type="text" value="<?php echo $result[0]['STIH_DESC']?>"name="STIH_DESC" id="STIH_DESC" placeholder="STIH_DESC" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Status</label>
			    <div class="col-md-2">
				<input type="text" value="<?php echo $result[0]['STIH_STATUS']?>"name="STIH_STATUS" placeholder="STIH_STATUS" id="STIH_STATUS" class="form-control">
			    </div>
			    ...
			    <div class="col-md-2">
				<input type="text"value="<?php echo $result[0]['STIH_DLV_DT']?>" name="STIH_DLV_DT" id="STIH_TXN_DT" placeholder="STIH_DLV_DT" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Requested by</label>
			    <div class="col-md-2">
				<input type="text"value="<?php echo $result[0]['STIH_REQUESTED_BY']?>" name="STIH_REQUESTED_BY" id="STIH_REQUESTED_BY" placeholder="STIH_REQUESTED_BY" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">From Locatin</label>
			    <div class="col-md-2">
			    <select name="STIH_SRC_LO" id="STIH_SRC_LO"class="form-control">
				<option value="">STIH_SRC_LO</option>
				<?php if (count($location) > 0 )
				{
				foreach ($location as $row)
				{
				?>
				<option <?php if($result[0]['STIH_SRC_LOCN_CODE']==$row['LOCN_CODE']) { echo "selected"; } ?> value="<?php echo $row['LOCN_CODE']; ?>"><?php echo $row['LOCN_DESC']; ?></option>
                               <?php } }?>
				</select>
			    </div>
				...
				<option value="">STIH_DLV_LO</option>
				<?php if (count($location) > 0 )
				{
				foreach ($location as $row)
				{
				?>
				<option <?php if($result[0]['STIH_DLV_LOCN_CODE']==$row['LOCN_CODE']) { echo "selected"; } ?> value="<?php echo $row['LOCN_CODE']; ?>"><?php echo $row['LOCN_DESC']; ?></option>
                               <?php } }?>
				</select>
                            ...
                            <div class="p-t-20 col-md-12">
                                ...
                                <div class="tab-content">
                                    <div id="nav-pills-tab-1" class="tab-pane fade  ">
                                        <h3 class="m-t-10"></h3>
                                        <div class="row">
						...
						<label class="col-md-1 control-label">Flex 20</label>
							...
							<input type="text" name="stoh_flix_20" placeholder="STOH_FLEX_20" id="stoh_flix_20" class="form-control">
                                    ...
                                    <div id="nav-pills-tab-2" class="tab-pane active fade in">
                                        <h3 class="m-t-10"></h3>
                                        <div class="row">
							...
							?>
							<tr  class="odd">
							    <input type="hidden" class="form-control" name="LINE_SYS_ID[]" value="<?php echo $row['STIL_SYS_ID']?>" >
							    <input type="hidden" class="form-control" name="STIL_VALUE[]" value="<?php echo $row['STIL_VALUE']?>" >
							    <input type="hidden" class="form-control" name="STIL_DLV_LOCN_CODE[]" value="<?php echo $row['STIL_DLV_LOCN_CODE']?>" >
							    <input type="hidden" class="form-control" name="STIL_SRC_LOCN_CODE[]" value="<?php echo $row['STIL_SRC_LOCN_CODE']?>" >
							    <input type="hidden" class="form-control datefor" name="STIL_DLV_DT[]" value="<?php echo $row['STIL_DLV_DT']?>" >
							    <input type="hidden" class="form-control" name="STIL_SYS_ID[]" value="<?php echo $row['STIL_REF_LINE_SYS_ID']?>" >
							    <input type="hidden" class="form-control" name="STIL_STIH_SYS_ID[]" value="<?php echo $row['STIL_REF_SYS_ID']?>" >
							    <input type="hidden" class="form-control" name="TXN_FLOW_SEQ[]" value="<?php echo $row['STIL_REF_FLOW_SEQ']?>" >
							    <input type="hidden" class="form-control" name="mil_line[]" value="<?php echo $row['STIL_PRICE']?>" >
							    <td><span><input type="text" class="form-control" name="STIL_LINE[]" value="<?php echo $row['STIL_LINE']?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="STIH_TXN_CODE1[]" value="<?php echo $row['STIL_REF_TXN_CODE']?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="STIH_TXN_NO[]" value="<?php echo $row['STIL_REF_TXN_NO']?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="STIL_ITEM_CODE[]" value="<?php echo $row['STIL_ITEM_CODE']?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="STIL_ITEM_DESC[]" value="<?php echo $row['STIL_ITEM_DESC']?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="STIL_UOM_CODE[]" value="<?php echo $row['STIL_UOM_CODE']?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="STIL_QTY[]" value="<?php echo $row['STIL_QTY']?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="STIL_DESC[]"value="<?php echo $row['STIL_DESC']?>" ></span></td>
			    ...
			    <fieldset>
				    ...
				    <button class="btn btn-sm btn-danger" type="button" onclick="window.history.back();">Cancel</button>
                                    ...
                                    <input type="submit" name="Save" class="btn btn-sm btn-success" value="Update">
                                </div>
                            </fieldset>
                           </div> 
			</form>
