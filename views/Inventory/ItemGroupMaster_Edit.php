...
<div id="content" class="content">
	...
	<li class="active">Edit Item Group Master</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Item Group Master <small> Enter the correct details here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Edit Item Group Master</h4>
		</div>
		<div class="panel-body">
		    <div class="col-md-offset-1 col-md-7">
			<form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo site_url('InventoryController/ItemGroupMaster_Edit');?>" class="form-horizontal">
			    <div class="form-group">
				<label class="col-md-3 control-label">Item Group Code</label>
				<div class="col-md-5">
				    <input type="text" name="ig_code" value="<?php echo $result[0]['IG_CODE'];?>" class="form-control" placeholder="IG_CODE" id="ig_code" readonly>
                                </div>
				<div class="col-md-offset-2 col-md-2 checkbox">
				    <label>
				    <input type="checkbox" name="item_active" value="Y" <?php echo ($result[0]['IG_ACTIVE_YN']=='Y' ? 'checked' : '' ) ?> >
				    Active ?
				    </label>
				</div>
			    </div>
				...
				<div class="col-md-9">
				    <input type="text" name="ig_desc"  value="<?php echo $result[0]['IG_DESC'];?>" placeholder="IG_DESC" id="ig_desc" class="form-control">
                                </div>
			    </div>
			    <fieldset>
