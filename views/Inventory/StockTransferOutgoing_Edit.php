...
<div id="content" class="content">
	...
	<li class="active">Edit Stock Transfer Outgoing</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Stock Transfer Outgoing <small> Enter the correct details here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Edit Stock Transfer Outgoing</h4>
		</div>
		<div class="panel-body">
                        <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo site_url('InventoryController/StockTransferOutgoing_Edit');?>" class="form-horizontal">
			    <div class="row">
			    <label class="col-md-1 control-label">Transaction Code</label>
			    <div class="col-md-2">
				<input type="text" placeholder="STOH_CODE" name="stoh_txn_code" value="<?php echo $result[0]['STOH_TXN_CODE']?>" class="form-control" readonly>
				<input type="hidden"  name="stoh_sys_id" value="<?php echo $result[0]['STOH_SYS_ID']?>" class="form-control" readonly>
			    </div>
			    <label class="col-md-1 control-label">Transaction No</label>
			    <div class="col-md-2">
				<input type="text" name="stoh_txn_no" value="<?php echo $result[0]['STOH_TXN_NO']?>" placeholder="STOH_TXN_NO" id="srqh_txn_no" class="form-control" readonly>
			    </div>
			    <label class="col-md-1 control-label">Transaction Desc</label>
			    <div class="col-md-2">
				<input type="text" name="stoh_txn_desc" value="<?php echo $result[0]['STOH_DESC']?>" placeholder="STOH_TXN_DESC" id="stoh_txn_desc" class="form-control" >
			    </div>
			    <label class="col-md-1 control-label">Txn Date</label>
			   <div class="col-md-2">
				<input type="text" name="stoh_txn_dt" value="<?php echo $result[0]['STOH_TXN_DT']?>" id="datepicker" placeholder="STOH_TXN_DT" id="stoh_txn_dt" class="form-control">
			    </div>
                           </div>
			    <div class="row p-t-20">
			    <label class="col-md-1 control-label">Description</label>
			    <div class="col-md-5">
				<input type="text" name="stoh_desc" value="<?php echo $result[0]['STOH_DESC']?>" id="stoh_desc" placeholder="STOH_DESC" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Status</label>
			    <div class="col-md-2">
				<input type="text" name="stoh_status" value="<?php echo $result[0]['STOH_STATUS']?>" placeholder="STOH_STATUS" id="stoh_status" class="form-control">
			    </div>
			    ...
			    <div class="col-md-2">
				<input type="text" name="stoh_requested_by" value="<?php echo $result[0]['STOH_REQUESTED_BY']?>" id="stoh_requested_by" placeholder="STOH_REQUESTED_BY" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Source Locatin</label>
			    <div class="col-md-2">
				<input type="text" name="stoh_src_loc" value="<?php echo $result[0]['STOH_SRC_LOCN_CODE']?>" placeholder="STOH_SRC_LO" id="stoh_src_loc" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Delivery Locatin</label>
			    <div class="col-md-2">
				<input type="text" name="stoh_delv_loc" value="<?php echo $result[0]['STOH_DLV_LOCN_CODE']?>" placeholder="STOH_DLV_LO" id="stoh_delv_loc" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Delivery Date</label>
			    <div class="col-md-2">
				<input type="text" name="stoh_delv_dt" value="<?php echo $result[0]['STOH_DLV_DT']?>" id="datepicker" placeholder="STOH_DLV_DT" id="stoh_delv_dt" class="form-control">
			    </div>
			    </div> 
							...
							<input type="text" name="stoh_flix_20" placeholder="STOH_FLEX_20" id="stoh_flix_20" class="form-control">
							    ...
							    <th><center>Line</center></th>
                                                    ...
                                                    <tbody>
                                                        <?php foreach($result1 as $row1) {?>
							<tr  class="odd">
							    <input type="hidden" class="form-control" name="stol_sys_id[]" value="<?php echo $row1['STOL_SYS_ID']?>" >
							    <input type="hidden" class="form-control" name="stol_stoh_sys_id[]" value="<?php echo $row1['STOL_STOH_SYS_ID']?>" >
							    <input type="hidden" class="form-control" name="stol_txn_flow_seq[]" value="<?php echo $row1['STOL_REF_FLOW_SEQ']?>" >
							    <input type="hidden" class="form-control" name="stol_price[]" value="<?php echo $row1['STOL_PRICE']?>" >
							    <input type="hidden" class="form-control" name="stol_ref_line_sys_id[]" value="<?php echo $row1['STOL_REF_LINE_SYS_ID']?>" >
							    <input type="hidden" class="form-control" name="stol_qty_delv[]" value="<?php echo $row1['SRQL_QTY_DELIVERED']?>" >
							    <input type="hidden" class="form-control" name="stol_value[]" value="<?php echo $row1['STOL_VALUE']?>" >
							    <input type="hidden" class="form-control" id="datepicker" name="stol_dlv_dt[]" value="<?php echo $row1['STOL_DLV_DT']?>" >
							    <input type="hidden" class="form-control" name="stol_src_loc[]" value="<?php echo $row1['STOL_SRC_LOCN_CODE']?>" >
							    <input type="hidden" class="form-control" name="stol_dlv_loc[]" value="<?php echo $row1['STOL_DLV_LOCN_CODE']?>" >
							    <td><span><input type="text" class="form-control" name="stol_line[]" value="<?php echo $row1['STOL_LINE'];?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="stol_txn_code[]" value="<?php echo $row1['STOL_REF_TXN_CODE']?>" readonly></span></td>
							    <td><span><input type="text" class="form-control" name="stol_txn_no[]" value="<?php echo $row1['STOL_REF_TXN_NO']?>" readonly></span></td>
							    <td><span><input type="text" class="form-control" name="stol_item_code[]" value="<?php echo $row1['STOL_ITEM_CODE']?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="stol_item_desc[]" value="<?php echo $row1['STOL_ITEM_DESC']?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="stol_uom_code[]" value="<?php echo $row1['STOL_UOM_CODE']?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="stol_qty[]" value="<?php echo $row1['STOL_QTY']?>" ></span></td>
							    <td><span><input type="text" class="form-control" name="stol_desc[]" value="<?php echo $row1['STOL_DESC']?>"></span></td>
							    <td><a class="btn btn-remove btn-danger btn-sm removeButton" data-template="textbox" href="<?php echo site_url('InventoryController/DeleteSTOL/'.$row1['STOL_SYS_ID'].'/'.$row1['STOL_LANG_CODE'].'/'.$row1['STOL_CR_UID']);?>">Remove</a></td>
							</tr>
							<?php } ?>
