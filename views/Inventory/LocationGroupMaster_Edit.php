...
<div id="content" class="content">
	...
	<li class="active">Edit Location Group Master</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Location Group Master <small> Enter the correct details here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Edit Location Group Master</h4>
		</div>
		<div class="panel-body">
                        <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo site_url('InventoryController/LocationGroupMaster_Edit');?>" class="form-horizontal">
			    <div class="col-md-offset-1 col-md-7">
                            <div class="form-group">
				<label class="col-md-3 control-label">Location Group Code</label>
				<div class="col-md-5">
				    <input type="text" placeholder="LG_CODE" class="form-control text-uppercase" name="lg_code" value="<?php echo $result[0]['LG_CODE']?>" id="lg_code" readonly> 
				</div>
				<div class="col-md-offset-2 col-md-2 checkbox">
				    <label>
				    <input type="checkbox" name="lg_active" <?php echo ($result[0]['LG_ACTIVE_YN']=='Y' ? 'checked' : '')?> value="Y">
				    Active ?
				    </label>
				</div>
			    </div>
				...
				<div class="col-md-9">
				    <input type="text" placeholder="LG_DESC" name="lg_desc" id="lg_desc" value="<?php echo $result[0]['LG_DESC']?>" class="form-control">
				</div>
			    </div>
				...
				<div class="col-md-3">
				      <label class="radio-inline">
                                            <input type="radio"  value="S" name="lgt" <?php echo ($result[0]['LG_TYPE']=='S' ? 'checked' : '')?>>
                                            Stocking Group
                                    </label>
				</div>
				<div class="col-md-3">
				    <label class="radio-inline">
                                            <input type="radio" value="C" name="lgt" <?php echo ($result[0]['LG_TYPE']=='C' ? 'checked' : '')?>>
                                            Costing Group
                                    </label>
				</div>
			    </div>
