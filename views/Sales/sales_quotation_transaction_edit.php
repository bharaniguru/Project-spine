...
<div class="content" id="content">
                     ...
                     <!-- end breadcrumb -->
                     <!-- begin page-header -->
                     <h1 class="page-header">Stock Transfer Request Transaction <small>you may edit here...</small></h1>
                     <!-- end page-header -->
        ...
        <div class="ui-sortable">
            ...
            <div data-sortable-id="form-stuff-1" class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" name="myForm" id="myForm" action="<?php echo base_url();?>Sales/SalesQuotationTransactionEdit" method="post" enctype="multipart/form-data">
					    ...
					    <input class="hidden" id="QH_COMP_CODE" name="QH_COMP_CODE" placeholder="QH_COMP_CODE" type="text" value="<?php echo $head[0]['QH_COMP_CODE'];?>">
					     <input class="hidden" id="QH_GROSS_VALUE" name="QH_GROSS_VALUE" placeholder="QH_GROSS_VALUE" type="text" value="<?php echo $head[0]['QH_GROSS_VALUE'];?>">
					     <input class="hidden" id="QH_GROSS_VALUE_LC" name="QH_GROSS_VALUE_LC" placeholder="QH_GROSS_VALUE_LC" type="text"  value="<?php echo $head[0]['QH_NET_VALUE_LC'];?>">
						
					     <input class="hidden" id="QH_TAX_PCT" name="QH_TAX_PCT" placeholder="QH_TAX_PCT" type="text" value="<?php echo $head[0]['QH_TAX_PCT'];?>">
					     <input class="hidden" id="QH_TAX_VALUE" name="QH_TAX_VALUE" placeholder="QH_TAX_VALUE" type="text" value="<?php echo $head[0]['QH_TAX_VALUE'];?>">
						
					     <input class="hidden" id="QH_DISCOUNT_PCT" name="QH_DISCOUNT_PCT" placeholder="QH_DISCOUNT_PCT" type="text" value="<?php echo $head[0]['QH_DISCOUNT_PCT'];?>">
					     <input class="hidden" id="QH_DISCOUNT_VALUE" name="QH_DISCOUNT_VALUE" placeholder="QH_DISCOUNT_VALUE" type="text" value="<?php echo $head[0]['QH_DISCOUNT_VALUE'];?>">
					     <input class="hidden" id="QH_OVERHEAD_PCT" name="QH_OVERHEAD_PCT" placeholder="QH_OVERHEAD_PCT" type="text" value="<?php echo $head[0]['QH_OVERHEAD_PCT'];?>">
					     <input class="hidden" id="QH_OVERHEAD_VALUE" name="QH_OVERHEAD_VALUE" placeholder="QH_OVERHEAD_VALUE" type="text" value="<?php echo $head[0]['QH_OVERHEAD_VALUE'];?>">
					     <input class="hidden" id="QH_NET_VALUE" name="QH_NET_VALUE" placeholder="QH_NET_VALUE" type="text" value="<?php echo $head[0]['QH_NET_VALUE'];?>">
					     <input class="hidden" id="QH_NET_VALUE_LC" name="QH_NET_VALUE_LC" placeholder="QH_NET_VALUE_LC" type="text" value="<?php echo $head[0]['QH_NET_VALUE_LC'];?>">
					     <input class="hidden" id="QH_TOTAL_LINES" name="QH_TOTAL_LINES" placeholder="QH_TOTAL_LINES" type="text" value="<?php echo $head[0]['QH_TOTAL_LINES'];?>">
					     <input class="hidden" id="QH_STATUS" name="QH_STATUS" placeholder="QH_STATUS" type="text" value="<?php echo $head[0]['QH_STATUS'];?>">	
						
						
					     <input class="hidden" id="PLH_CODE" name="PLH_CODE" placeholder="PLH_CODE" type="text" value="<?php //echo $head[0]['PLH_CODE'];?>">
					     <input class="hidden" id="QH_SALE_TYPE" name="QH_SALE_TYPE" placeholder="QH_SALE_TYPE" type="text" value="<?php echo $head[0]['QH_SALE_TYPE'];?>" >
					     <input class="hidden" id="QH_OVERHEAD_PCT" name="QH_OVERHEAD_PCT" placeholder="QH_OVERHEAD_PCT" type="text" value="<?php echo $head[0]['QH_OVERHEAD_PCT'];?>">
					     <input class="hidden" id="QH_OVERHEAD_VALUE" name="QH_OVERHEAD_VALUE" placeholder="QH_OVERHEAD_VALUE" type="text" value="<?php echo $head[0]['QH_OVERHEAD_VALUE'];?>">
						<input class="hidden" id="QH_CUST_ID" name="QH_CUST_ID" placeholder="QH_CUST_ID" type="text" value="<?php echo $head[0]['QH_CUST_ID'];?>">
					     <input class="hidden" id="QH_CUST_TYPE" name="QH_CUST_TYPE" placeholder="QH_CUST_TYPE" type="text" value="<?php echo $head[0]['QH_CUST_TYPE'];?>">
					    <input type="hidden" name="QH_LANG_CODE" id="QH_LANG_CODE" value="<?php echo $head[0]['QH_LANG_CODE'];?>">
				     ...
				     <div class="row"><!--Inner row defined BEGIN-->
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                             <input type="text" placeholder="QH_CONTACT_NO"  name="QH_CONTACT_NO" id="QH_CONTACT_NO" class="form-control" value="<?php echo $head[0]['QH_CONTACT_NO'];?>">
                                         </div>
                                         </div>
                                     </div><!--Inner row END-->
                                     <div class="row"><!--Inner row defined BEGIN-->
                                         ...
                                         <div class="col-md-8">
                                             <input type="text" placeholder="QH_CUST_AC_CODE"  name="QH_CUST_AC_CODE" id="QH_CUST_AC_CODE" class="form-control" value="<?php echo $head[0]['QH_CUST_AC_CODE'];?>">
                                         </div>
                                         </div>
                                     </div><!--Inner row END-->
				     <div class="row"><!--Inner row defined BEGIN-->
                                         ...
                                         <div class="col-md-8">
                                             <input type="text" placeholder="QH_CUST_AC_DESC"  name="QH_CUST_AC_DESC" id="QH_CUST_AC_DESC" class="form-control" value="<?php echo $head[0]['QH_CUST_AC_DESC'];?>">
                                         </div>
                                         </div>
                                     </div><!--Inner row END-->
				     <div class="row"><!--Inner row defined BEGIN-->
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                             <input type="text" placeholder="QH_DESC"  name="QH_DESC" id="QH_DESC" class="form-control" value="<?php echo $head[0]['QH_DESC'];?>">
                                         </div>
                                         </div>
                                     </div><!--Inner row END-->
                                     ...
                                     <div class="row"><!--Inner row defined BEGIN-->
                                      ...
                                      <div class="row"><!--Inner row defined BEGIN-->
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                             <input type="text" placeholder="QH_DOC_REF"  name="QH_DOC_REF" id="QH_DOC_REF" class="form-control" value="<?php echo $head[0]['QH_DOC_REF'];?>">
                                         </div>
                                         </div>
                                     </div><!--Inner row END-->
                                      <div class="row"><!--Inner row defined BEGIN-->
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                             <input type="text" placeholder="QH_DELIVERY_DT"  name="QH_DELIVERY_DT" id="QH_DELIVERY_DT" class="form-control datepicker-dob" value="<?php echo $head[0]['QH_DELIVERY_DT'];?>">
                                         </div>
                                         </div>
                                     </div><!--Inner row END-->
                                      <div class="row"><!--Inner row defined BEGIN-->
						...
						<select class="form-control" id="QH_DELIVERY_CODE" name="QH_DELIVERY_CODE">
						   <option disabled="" selected="" value="0">Select</option>
						       ...
						       <option <?php if($head[0]['QH_DELIVERY_CODE']==$row['VSL_CODE'] ) echo "selected"; ?> value="<?php echo $row['VSL_CODE'];?>"><?php echo $row['VSL_DESC'];?></option>
						       <?php }?>
                                ...
                                <div class="col-md-3 ui-sortable"><!-- THIRD COL-6 BEGIN-->
                                    <div class="row"><!--Inner row defined BEGIN-->
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                             <input type="text"  placeholder="QH_TXN_DT" readonly name="QH_TXN_DT" id="QH_TXN_DT" class="txn_date form-control" value="<?php echo $head[0]['QH_TXN_DT'];?>">
                                         </div>
                                         </div>
                                     </div><!--Inner row END-->
                                    <div class="row"><!--Inner row defined BEGIN-->
                                ...
                                <div class="row">
                                    <div class="col-md-6 ui-sortable well"><!-- FIRST COL-6 BEGIN-->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="QH_BILL_ADD1" name="QH_BILL_ADD1" class="form-control" placeholder="QH_BILL_ADD1" value="<?php echo $head[0]['QH_BILL_ADD1'];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"></label>
                                            <div class="col-md-9">
                                                <input type="text" id="QH_BILL_ADD2" name="QH_BILL_ADD2" class="form-control" placeholder="QH_BILL_ADD2" value="<?php echo $head[0]['QH_BILL_ADD2'];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"></label>
                                            <div class="col-md-9">
                                                <input type="text" id="QH_BILL_ADD3" name="QH_BILL_ADD3" class="form-control" placeholder="QH_BILL_ADD3" value="<?php echo $head[0]['QH_BILL_ADD3'];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"></label>
                                            <div class="col-md-9">
                                                <input type="text" id="QH_BILL_ADD4" name="QH_BILL_ADD4" class="form-control" placeholder="QH_BILL_ADD4" value="<?php echo $head[0]['QH_BILL_ADD4'];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <?php if (count($country) > 0 )
                                                  ...
                                                  {
                                                  ?>
						  <option <?php if($head[0]['QH_DELIVERY_CODE']==$row['CN_CODE'] ) echo "selected"; ?> value="<?php echo $row['CN_CODE'];?>"><?php echo $row['CN_DESC'];?></option>
						    ...
						    <?php if (count($state) > 0 )
                                                  ...
                                                  {
                                                  ?>
						  <option <?php if($head[0]['QH_BILL_ST_CODE']==$row['ST_CODE'] ) echo "selected"; ?> value="<?php echo $row['ST_CODE'];?>"><?php echo $row['ST_DESC'];?></option>
						    ...
						    <?php if (count($city) > 0 )
                                                  ...
                                                  {
                                                  ?>
						  <option <?php if($head[0]['QH_BILL_CT_CODE']==$row['CT_CODE'] ) echo "selected"; ?> value="<?php echo $row['CT_CODE'];?>"><?php echo $row['CT_DESC'];?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="QH_BILL_POSTAL" name="QH_BILL_POSTAL" class="form-control" placeholder="QH_BILL_POSTAL" value="<?php echo $head[0]['QH_BILL_POSTAL'];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Mobile</label>
                                            <div class="col-md-9">
                                                <input type="text" id="QH_BILL_MOBILE" name="QH_BILL_MOBILE" class="form-control" placeholder="QH_BILL_MOBILE" value="<?php echo $head[0]['QH_BILL_MOBILE'];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Phone</label>
                                            <div class="col-md-9">
                                                <input type="text" id="QH_BILL_PHONE" name="QH_BILL_PHONE" class="form-control" placeholder="QH_BILL_PHONE" value="<?php echo $head[0]['QH_BILL_PHONE'];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Fax</label>
                                            <div class="col-md-9">
                                                <input type="text" id="QH_BILL_FAX" name="QH_BILL_FAX" class="form-control" placeholder="QH_BILL_FAX" value="<?php echo $head[0]['QH_BILL_FAX'];?>"/>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-md-3 control-label">Email</label>
                                            <div class="col-md-9">
                                                <input type="text" id="QH_BILL_EMAIL" name="QH_BILL_EMAIL" class="form-control" placeholder="QH_BILL_EMAIL" value="<?php echo $head[0]['QH_BILL_EMAIL'];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Contact Person</label>
                                            <div class="col-md-9">
                                                <input type="text" id="QH_BILL_CONTACT" name="QH_BILL_CONTACT" class="form-control" placeholder="QH_BILL_CONTACT" value="<?php echo $head[0]['QH_BILL_CONTACT'];?>"/>
                                            </div>
                                        </div>
                                    </div><!-- FIRST COL-6 End-->
						...
						<div class="col-md-9">
						   <input type="text" placeholder="Date Start" name="QH_EFF_FROM_DT" id="datetimepicker6" class="form-control"  value="<?php echo $head[0]['QH_EFF_FROM_DT'];?>">
						</div>
					 </div>
					 <div class="form-group">
					     <label class="col-md-3 control-label">Upto Date</label>
						  <div class="col-md-9">
						    <input type="text" placeholder="Date End" name="QH_EFF_UPTO_DT" id="datetimepicker7" class="form-control" value="<?php echo $head[0]['QH_EFF_UPTO_DT'];?>">
						  </div>
					 </div>
                                        <div class="form-group">
					     ...
					     <option <?php if($head[0]['QH_PT_CODE']==$row['PT_CODE'] ) echo "selected"; ?> value="<?php echo $row['PT_CODE'];?>"><?php echo $row['PT_DESC'];?></option>
					     <?php }?>
						</select>
                                            </div>
                                        </div>
					     ...
					     <option <?php if($head[0]['QH_SHIP_CODE']==$row['SH_CODE'] ) echo "selected"; ?> value="<?php echo $row['SH_CODE'];?>"><?php echo $row['SH_DESC'];?></option>
					     <?php }?>
						</select>
                                            </div>
					     ...
					     <option <?php if($head[0]['QH_CARRIER_CODE']==$row['CA_CODE'] ) echo "selected"; ?> value="<?php echo $row['CA_CODE'];?>"><?php echo $row['CA_DESC'];?></option>
					     <?php }?>
						</select>
                                            </div>
						...
						<select class="form-control" id="QH_FREIGHT_CODE" name="QH_FREIGHT_CODE">
						      ...
						      <option <?php if($head[0]['QH_FREIGHT_CODE']==$row['VSL_CODE'] ) echo "selected"; ?> value="<?php echo $row['VSL_CODE'];?>"><?php echo $row['VSL_DESC'];?></option>
						       <?php }?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="QH_DELIVERY_TERMS" name="QH_DELIVERY_TERMS" class="form-control" placeholder="QH_DELIVERY_TERMS" value="<?php echo $head[0]['QH_DELIVERY_TERMS'];?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
						...
						<select class="form-control" id="QH_CCY_CODE" name="QH_CCY_CODE">
						       ...
						       <option <?php if($head[0]['QH_CCY_CODE']==$row['CCY_CODE'] ) echo "selected"; ?> value="<?php echo $row['CCY_CODE'];?>"><?php echo $row['CCY_DESC'];?></option>
						       <?php }?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="QH_EXC_RATE" name="QH_EXC_RATE" readonly class="form-control" placeholder="QH_EXC_RATE" value="<?php echo $head[0]['QH_EXC_RATE'];?>"/>
                                        </div>
                                        </div>
				...
				<div class="col-md-9">
				    <input type="text" id="QH_SHIP_ADD1" name="QH_SHIP_ADD1" class="form-control" placeholder="QH_SHIP_ADD1" value="<?php echo $head[0]['QH_SHIP_ADD1'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label"></label>
				<div class="col-md-9">
				    <input type="text" id="QH_SHIP_ADD2" name="QH_SHIP_ADD2" class="form-control" placeholder="QH_SHIP_ADD2" value="<?php echo $head[0]['QH_SHIP_ADD2'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label"></label>
				<div class="col-md-9">
				    <input type="text" id="QH_SHIP_ADD3" name="QH_SHIP_ADD3" class="form-control" placeholder="QH_SHIP_ADD3" value="<?php echo $head[0]['QH_SHIP_ADD3'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label"></label>
				<div class="col-md-9">
				    <input type="text" id="QH_SHIP_ADD4" name="QH_SHIP_ADD4" class="form-control" placeholder="QH_SHIP_ADD4" value="<?php echo $head[0]['QH_SHIP_ADD4'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<div class="col-md-9">
					...
					<option value="0">Select Country</option>
                                                <?php if (count($country) > 0 )
                                                  ...
                                                  {
                                                  ?>
                                                 <option <?php if($head[0]['QH_SHIP_CN_CODE']==$row['CN_CODE'] ) echo "selected"; ?> value="<?php echo $row['CN_CODE'];?>"><?php echo $row['CN_DESC'];?></option>
                                                  <?php } }?>
				...
				<label class="col-md-3 control-label">State</label>
				<div class="col-md-9">
				    <select class="form-control" id="QH_SHIP_ST_CODE" name="QH_SHIP_ST_CODE">city_ship
				      <?php if (count($state_ship) > 0 )
                                                  {
                                                  foreach ($state_ship as $row)
                                                  {
                                                  ?>
						  <option <?php if($head[0]['QH_SHIP_ST_CODE']==$row['ST_CODE'] ) echo "selected"; ?> value="<?php echo $row['ST_CODE'];?>"><?php echo $row['ST_DESC'];?></option>
				...
				<div class="col-md-9">
				    <select class="form-control" id="QH_SHIP_CT_CODE" name="QH_SHIP_CT_CODE">
				         <?php if (count($city_ship) > 0 )
                                                  {
                                                  foreach ($city_ship as $row)
                                                  {
                                                  ?>
						  <option <?php if($head[0]['QH_SHIP_CT_CODE']==$row['CT_CODE'] ) echo "selected"; ?> value="<?php echo $row['CT_CODE'];?>"><?php echo $row['CT_DESC'];?></option>
				...
				<label class="col-md-3 control-label">PO Box</label>
				<div class="col-md-9">
				    <input type="text" id="QH_SHIP_POSTAL" name="QH_SHIP_POSTAL" class="form-control" placeholder="QH_SHIP_POSTAL" value="<?php echo $head[0]['QH_SHIP_POSTAL'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label">Mobile</label>
				<div class="col-md-9">
				    <input type="text" id="QH_SHIP_MOBILE" name="QH_SHIP_MOBILE" class="form-control" placeholder="QH_SHIP_MOBILE" value="<?php echo $head[0]['QH_SHIP_MOBILE'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label">Phone</label>
				<div class="col-md-9">
				    <input type="text" id="QH_SHIP_PHONE" name="QH_SHIP_PHONE" class="form-control" placeholder="QH_SHIP_PHONE" value="<?php echo $head[0]['QH_SHIP_PHONE'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label">Fax</label>
				<div class="col-md-9">
				    <input type="text" id="QH_SHIP_FAX" name="QH_SHIP_FAX" class="form-control" placeholder="QH_SHIP_FAX" value="<?php echo $head[0]['QH_SHIP_FAX'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label">Email</label>
				<div class="col-md-9">
				    <input type="text" id="QH_SHIP_EMAIL" name="QH_SHIP_EMAIL" class="form-control" placeholder="QH_SHIP_EMAIL" value="<?php echo $head[0]['QH_SHIP_EMAIL'];?>"/>
				</div>
			    </div>
                            </div>
                            <div class="row"> 
				...
				<label class="col-md-3 control-label">Contact Person</label>
				<div class="col-md-9">
				    <input type="text" id="QH_SHIP_CONTACT" name="QH_SHIP_CONTACT" class="form-control" placeholder="QH_SHIP_CONTACT" value="<?php echo $head[0]['QH_SHIP_CONTACT'];?>"/>
				</div>
                            </div>
                            </div>
                        </div><!-- Second COL-6 End-->
	...
	<input type="hidden"  name="QL_GEO_LONGI[]" value="<?php echo $row['QL_GEO_LATI']?>" >
	<input type="hidden"  name="QL_GEO_LATI[]" value="<?php echo $row['QL_GEO_LONGI']?>" >
	<input type="hidden"  name="STIL_SRC_LOCN_CODE[]" value="<?php //echo $row['STOL_SRC_LOCN_CODE']?>" >
	<input type="hidden"  name="STIL_DLV_DT[]" value="<?php //echo $row['STOL_DLV_DT']?>" >
	<input type="hidden"  name="STIL_SYS_ID[]" value="<?php //echo $row['STOL_SYS_ID']?>" >
	<input type="hidden"  name="STIL_STIH_SYS_ID[]" value="<?php //echo $row['STOL_STOH_SYS_ID']?>" >
	<input type="hidden"  id="QL_ITEM_CODE_Applicable[]" name="QL_ITEM_CODE_Applicable[]" >
	<input type="hidden"  name="QL_COLOR_CODE[]" value="<?php echo $row['QL_COLOR_CODE']?>" >
	
	
	<td><span><input type="text"  name="QL_LINE[]" value="<?php echo $row['QL_LINE'];;?>" ></span></td>
	<td><span><!--<input type="hidden"  name="QL_PRODUCT_CODE[]" value="<?php //echo $row['QL_PRODUCT_CODE']?>" >-->
	<select  id="QL_PRODUCT_CODE[]"   name="QL_PRODUCT_CODE[]">
	    <option disabled="" selected="" value="0">Select</option>
		<?php foreach($prod  as $row1){  ?>
		<option <?php if($row['QL_PRODUCT_CODE']==$row1['IF_CODE'] ) echo "selected"; ?> value="<?php echo $row1['IF_CODE'];?>"> <?php echo $row1['IF_DESC'];?></option>
		<?php }?>
    
	</select>
	<!--<input type="hidden"  name="QL_PRODUCT_CODE[]" value="<?php //echo $row['QL_PRODUCT_CODE']?>" >-->
	</span>
	
	<?php
//	$prod_c=$row['QL_PRODUCT_CODE'];
//	$sql="SELECT ITEM_CODE FROM INVT_M_ITEM WHERE ITEM_IF_CODE='$prod_c' AND ITEM_ACTIVE_YN='Y'";
//     $item_code=$this->db->query($sql, $return_object = TRUE)->result_array();
	?>
	</td>
	<td><span>
	<select  id="QL_ITEM_CODE[]" name="QL_ITEM_CODE[]">
	 <option  value="0">Select Item</option>
	    <?php foreach($item_code  as $row2){  ?>
	    <option  <?php if($row['QL_ITEM_CODE']==$row1['ITEM_CODE'] ) echo "selected"; ?> value="<?php echo $row2['ITEM_CODE'];?>"><?php echo $row2['ITEM_CODE'];?></option>
	    <?php }?>
				
				    </select>
	</span></td>
	
	<td><span><input type="text"  name="QL_ITEM_DESC[]" value="<?php //echo $row['STOL_PRICE']?>" ></span></td>
	<td><span><input type="text" readonly name="QL_WIDTH[]" value="<?php echo $row['QL_WIDTH']?>" ></span></td>
	<td><span><input type="text" readonly name="QL_HEIGHT[]" value="<?php echo $row['QL_HEIGHT']?>" ></span></td>
	<td><span>
	<select  id="QL_UOM_CODE[]" name="QL_UOM_CODE[]">
					<option disabled="" selected="" value="0">Select UOM</option>
	...
	<td><span><input type="text"  name="QL_QTY[]" value="<?php echo $row['QL_QTY']?>" ></span>
	<span><input type="hidden"  name="QL_QTY_BU[]" value="<?php echo $row['QL_QTY']?>" ></span></td>
	<td><span><input type="text"  name="QL_PRICE[]" id="QL_PRICE[]" >
	<input type="hidden"  name="QL_VALUE[]" id="QL_VALUE[]">
	</span></td>

	
	<td id="mm"><span><input type="text"  name="QL_BUILD[]" value="<?php echo $row['QL_BUILD']?>"></span></td>
	<td id="mm"><span><input type="text"  name="QL_FLOOR[]" value="<?php echo $row['QL_FLOOR']?>" ></span></td>
	<td id="mm"><span><input type="text"  name="QL_FLAT[]" value="<?php echo $row['QL_FLAT']?>"></span></td>
	<td id="mm"><span><input type="text"  name="QL_UNIT[]" value="<?php echo $row['QL_UNIT']?>"></span></td>
	<td id="mm"><span>
	<select  id="QL_MOUNT_TYPE[]"  name="QL_MOUNT_TYPE[]">
		...
		<option <?php if($row['QL_MOUNT_TYPE']==$row1['VSL_CODE'] ) echo "selected"; ?> value="<?php echo $row1['VSL_CODE'];?>"> <?php echo $row1['VSL_DESC'];?></option>
		<?php }?>
	...
	<select  id="QL_MOUNT_ON[]"  name="QL_MOUNT_ON[]">
		...
		<option <?php if($row['QL_MOUNT_ON']==$row1['VSL_CODE'] ) echo "selected"; ?> value="<?php echo $row1['VSL_CODE'];?>"> <?php echo $row1['VSL_DESC'];?></option>
		<?php }?>
	...
	<select  id="QL_OPERATE[]"  name="QL_OPERATE[]">
		...
		<option <?php if($row['QL_OPERATE']=='Manual' ) echo "selected"; ?> value="Manual"> Manual</option>
		<option <?php if($row['QL_OPERATE']=='Motorized' ) echo "selected"; ?> value="Motorized"> Motorized</option>
	...
	<select  id="QL_CONTROL[]"  name="QL_CONTROL[]">
		...
		<option <?php if($row['QL_CONTROL']=='Left' ) echo "selected"; ?> value="Left">Left</option>
		<option <?php if($row['QL_CONTROL']=='Right' ) echo "selected"; ?> value="Right">Right</option>
	...
	<select  id="QL_OPENING[]"  name="QL_OPENING[]">
		...
		<option <?php if($row['QL_OPENING']=='Top' ) echo "selected"; ?> value="Top">Top</option>
		<option <?php if($row['QL_OPENING']=='Right' ) echo "selected"; ?> value="Right">Right</option>
		<option <?php if($row['QL_OPENING']=='Left' ) echo "selected"; ?> value="Left">Left</option>
		<option <?php if($row['QL_OPENING']=='Center' ) echo "selected"; ?> value="Center">Center</option>
	</select>
	</span></td>
	<td id="mm"><span>
	<select  id="QL_PELMET[]"  name="QL_PELMET[]">
		...
		<option <?php if($row['QL_PELMET']=='Yes' ) echo "selected"; ?> value="Yes">Yes</option>
		<option <?php if($row['QL_PELMET']=='No' ) echo "selected"; ?> value="No">No</option>
	</select>
	</span></td>
	<td id="mm"><span><input type="text"  name="QL_PROJECTION[]" value="<?php echo $row['QL_PROJECTION']?>"></span></td>
	<td id="mm"><span><input type="text"  name="QL_FASCIA[]" value="<?php echo $row['QL_FASCIA']?>"></span></td>
	...
	<td id="sd"><span><input type="text" readonly name="QL_GROSS_VALUE[]" >
	<input type="hidden"  name="QL_GROSS_VALUE_LC[]" >
	</span></td>
	<td id="sd"><span><input type="text"  name="QL_REMARKS[]" placeholder="remark about this"></span></td>
