...
$active_group = 'spine';
$active_record = TRUE;
//$tnsname = '(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.6.3)(PORT = 1521))(CONNECT_DATA = (SERVER = DEDICATED) (SID = spine)))';
$tnsname = '(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 168.63.241.70)(PORT = 1521))
