		...
		<ol class="breadcrumb pull-right">
		    <li>Logistics</li>
		    <li class="active">Edit Schedule Transaction</li>
		</ol>
		<!-- end breadcrumb -->
		<!-- begin page-header -->
		<h1 class="page-header">Edit Schedule Transaction in our spine<small> You may Edit Schedule Transaction here...</small></h1>
		<!-- end page-header -->
		<!-- begin row -->
		<div class="row">
		    <!-- begin col-10 -->
			...
			<div class="panel panel-inverse">
				...
				<h4 class="panel-title">Edit Schedule Transaction</h4>
			    </div><br>
			    <p style="color:red"><?php echo $status; ?></p>
			    <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo base_url('LogisticsController/ScheduleTransaction_Edit'); ?>" class="form-horizontal  form12">
				<div class="col-md-12">
				    <div class="col-md-6">
					<div class="col-md-5">
					    <input type="hidden" name="LSH_SYS_ID" class="form-group" value="<?php echo $Fetch_Head[0]['LSH_SYS_ID'] ;?>" placeholder="LSH_TXN_CODE"/>
					</div>
					<div class="col-md-5">
					    <input type="hidden" id="LSH_TXN_NO" name="LSH_TXN_NO" class="form-group" value="<?php echo $Fetch_Head[0]['LSH_TXN_NO'] ;?>"  placeholder="LSH_TXN_NO"/>
					</div>
					<div class="form-group">
					    <label class="col-md-3 control-label">Transaction</label>
					    <div class="col-md-7">
					       <input type="text" name="LSH_TXN_CODE" class="form-control" readonly value="<?php echo $Fetch_Head[0]['LSH_TXN_CODE'] ;?>" placeholder="LSH_TXN_CODE"/>
					    </div>
					</div>
					<div class="form-group">
					    <label class="col-md-3 control-label">Txn Date</label>
					    <div class="col-md-7">
					      <input type="text" id="defaultdate" readonly name="LSH_TXN_DT" class="form-control" value="<?php echo $Fetch_Head[0]['LSH_TXN_DT'] ;?>"  placeholder="LSH_TXN_DT"/>
					    </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					    ...
					    <div class="col-md-7">
						<input type="text" name="LSH_TXN_NO" readonly class="form-control" value="<?php echo $Fetch_Head[0]['LSH_TXN_NO'] ;?>"  placeholder="LSH_TXN_NO"/>
					    </div>
					</div>
					<div class="form-group">
				...
				<table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
				    ...
				    <tbody>
					<?php  foreach($Fetch_Lines as $row){ ?>
					<tr>
					    <td><?php echo $Fetch_Lines[0]['LSL_REF_TXN_CODE']?>
					    </td>
					    <td>
						<?php echo $Fetch_Lines[0]['LSL_REF_TXN_NO']?>
					    </td>
					    <td>
						<?php echo $Fetch_Lines[0]['LSL_REF_TXN_DT']?>
					    </td>
					    <td>
						<?php echo $Fetch_Lines[0]['LSL_CUST_AC_DESC']?>
					    </td>
					    <td>
						<?php echo $Fetch_Lines[0]['LSL_CONTACT_PERSON']?>
					    </td>
					    <td>
						<?php echo $Fetch_Lines[0]['LSL_CONTACT_NO']?>
					    </td>
					    <td>
						<?php echo $Fetch_Lines[0]['LSL_CN_CODE']?>
					    </td>
					    <td>
						<?php echo $Fetch_Lines[0]['LSL_ST_CODE']?>
					    </td>
					    <td>
						<?php echo $Fetch_Lines[0]['LSL_CT_CODE']?>
					    </td>
					    <td>
						<?php echo $Fetch_Lines[0]['LST_CT_AREA_CODE']?>
					    </td>
					    <td>
						<?php echo $Fetch_Lines[0]['LSL_REQUESTED_BY']?>
					    </td>
					     <td>
						<?php echo $Fetch_Lines[0]['LSL_JOB_CODET']?>
					    </td>
					    <td>
