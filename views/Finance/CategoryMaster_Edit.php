	...
	<p style="color: #EB4688"><?php if (isset($status)) { echo $status; } ?></p>
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Edit Category Mater</h4>
		    
		</div>
	    <div class="panel-body">
		<div class="">
		    <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo base_url('Finance/CategoryMaster_Edit/'.$category[0]['CATG_CODE']); ?>" class="form-horizontal">
		    <div class="col-md-6">
			...
			<div class="col-md-12">
			    <div class="form-group">
				    ...
				    <div class="col-md-6">
					<input type="text" readonly="" name="CATG_CODE" id="CATG_CODE" class="form-control" placeholder="CATG_CODE" value="<?php echo $category[0]['CATG_CODE']; ?>" />
				    </div>
			    </div>
			</div>
			<div class="col-md-12">
				...
				<div class="col-md-9">
					<input type="text" name="CATG_DESC" id="CATG_DESC" class="form-control" placeholder="CATG_DESC" value="<?php echo $category[0]['CATG_DESC']; ?>" />
				    </div>
			    </div>
			</div>
			...
			<div class="row">
                        ...
                        <label class="">
                        <input type="checkbox" name="checkbox" <?php  if($category[0]['CATG_ACTIVE_YN']=="Y") echo "checked"; ?> value="Y" id="ck1" > Active ?
                        </label>
                        </section>
                        </div>
		    </div>
