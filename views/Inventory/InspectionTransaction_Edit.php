...
<div id="content" class="content">
	...
	<li class="active">Edit Inspection Transaction</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header"> Edit Inspection Transaction <small> Enter the correct details here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Edit Inspection Transaction</h4>
		</div>
		<div class="panel-body">
                        <form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo site_url('InventoryController/InspectionTransaction_Edit');?>" class="form-horizontal">
			    <div class="row">
			    <label class="col-md-1 control-label">Transaction Code</label>
			    <div class="col-md-2">
				<input type="text" placeholder="INH_SUP" name="inh_Txn_code" value="<?php echo $result[0]['INH_TXN_CODE']?>" class="form-control" readonly>
				<input type="hidden" placeholder="INH_SUP" name="inh_sys_id" value="<?php echo $result[0]['INH_SYS_ID']?>" class="form-control" >
				<input type="hidden" placeholder="INH_SUP" name="inh_txn_no" value="<?php echo $result[0]['INH_TXN_NO']?>" class="form-control" >
                            </div>
			    <label class="col-md-1 control-label">Transaction No</label>
			    <div class="col-md-2">
				<input type="text" name="inh_txn_no" value="<?php echo $result[0]['INH_TXN_NO']?>" placeholder="INH_TXN_NO" class="form-control" readonly>
			    </div>
			   <label class="col-md-1 control-label">Txn Date</label>
			    <div class="col-md-2">
				<input type="text" name="inh_txn_dt" placeholder="INH_DT" id="datepicker" value="<?php echo $result[0]['INH_TXN_DT']?>" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Invoice Date</label>
			    <div class="col-md-2">
				<input type="text" name="inh_inv_dt" placeholder="INH_INV_DT" value="<?php echo $result[0]['INH_INV_DT']?>"  id="datepicker" class="form-control">
			    </div>
                           </div>
			     <div class="row p-t-20">
			    <label class="col-md-1 control-label">Supplier</label>
			    <div class="col-md-5">
				<input type="text" name="inh_sup" id="inh_sup" value="<?php echo $result[0]['INH_SUPL_CODE']?>" placeholder="INH_SUPL_CODE" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Location</label>
			    <div class="col-md-2">
				<select class="form-control" name="inh_locn_code" id="inh_locn_code">
				    <?php foreach($result3 as $row3) { ?>
				    <option value="<?php echo $row3['LOCN_CODE']?>" <?php if($row3['LOCN_CODE']==$result[0]['INH_LOCN_CODE']) echo 'Selected' ;?> ><?php echo $row3['LOCN_DESC']?></option>
				    <?php } ?>
				</select>
			    </div>
			    ...
			    <div class="col-md-2">
				<input type="text" name="inh_bill_dt" value="<?php echo $result[0]['INH_BILL_OF_ENTRY']?>" placeholder="INH_BILL_OF_DT" id="inh_bill_dt" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">FCL/LCL</label>
			    <div class="col-md-2">
				<input type="text" name="inh_bill_of_en" value="<?php echo $result[0]['INH_FCL_LCL']?>" placeholder="INH_BILL_OF_EN" id="inh_bill_of_en" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Invoice No</label>
			    <div class="col-md-2">
				<input type="text" name="inh_inv_no" value="<?php echo $result[0]['INH_INV_NO']?>" placeholder="INH_INV_NO" id="inh_inv_no" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Container Size</label>
			    <div class="col-md-2">
				<input type="text" name="inh_cont_size" value="<?php echo $result[0]['INH_CONTAINER_SIZE']?>" placeholder="INH_CONTAINER_SIZE" id="inh_cont_size" class="form-control">
			    </div>
			    </div>
			     <div class="row p-t-20">
			    <label class="col-md-1 control-label">Pkg Type</label>
			    <div class="col-md-2">
				<input type="text" name="inh_pkg_type" value="<?php echo $result[0]['INH_TYPE_OF_PKG']?>" placeholder="INH_PKG_TYPE" id="inh_pkg_type" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">No Pkg</label>
			    <div class="col-md-2">
				<input type="text" name="inh_no_pkg" value="<?php echo $result[0]['INH_NO_OF_PKG']?>" placeholder="INH_NO_PKG" id="inh_no_pkg" class="form-control">
			    </div>
			    <label class="col-md-1 control-label"></label>
			    <div class="col-md-2 checkbox">
			    <label>
				<input type="checkbox" name="inh_all_itm_ok"  value="Y" <?php if($result[0]['INH_ITEMS_OK_YN']=='Y') echo 'checked'?>>
				    All Items are OK? 
			    </label>
			    </div>
			    <label class="col-md-1 control-label"></label>
			   <div class="col-md-2 checkbox">
			    <label>
				<input type="checkbox" name="inh_all_item_acpt" value="Y" <?php if($result[0]['INH_ITEMS_ACC_YN']=='Y') echo 'checked'?>>
			...
			<!--    </div>-->
			    ...
			    <div class="col-md-2">
				<input type="text" name="inh_done_by" value="<?php echo $result[0]['INH_INSP_DONE_BY']?>" placeholder="INH_DONE_BY" id="inh_done_by" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Description</label>
			    <div class="col-md-2">
				<input type="text" name="inh_desc"  placeholder="INH_DESCRIPTION" value="<?php echo $result[0]['INH_DESC']?>" id="inh_desc" class="form-control">
			    </div>
			    <label class="col-md-1 control-label">Status</label>
			    <div class="col-md-2">
				<input type="text" name="inh_status" placeholder="INH_STATUS" value="<?php echo $result[0]['INH_STATUS']?>" id="inh_status" class="form-control">
			    </div>
			    </div>
						...
						<label class="col-md-1 control-label">Flex 20</label>
							...
							<tr class="odd">
							    <input type="hidden" class="form-control" name="INL_SYS_ID[]" value="<?php echo $row['INL_SYS_ID'];?>"/>
							    <input type="hidden" class="form-control" name="INL_INH_SYS_ID[]" value="<?php echo $row['INL_INH_SYS_ID'];?>"/>
							    <input type="hidden" class="form-control" name="INL_REF_FLOW_SEQ[]" value="<?php echo $row['INL_REF_FLOW_SEQ'];?>"/>
							    <input type="hidden" class="form-control" name="INL_REF_HEAD_SYS_ID[]" value="<?php echo $row['INL_REF_HEAD_SYS_ID'];?>"/>
							    <input type="hidden" class="form-control" name="INL_REF_LINE_SYS_ID[]" value="<?php echo $row['INL_REF_LINE_SYS_ID'];?>"/>
							    <td><span><input type="text" class="form-control" name="INL_LINE[]" value="<?php echo $row['INL_LINE'] ;?>"/></span></td>
							    <td><span><input type="text" class="form-control" name="INL_REF_TXN_CODE[]" value="<?php echo $row['INL_REF_TXN_CODE'];?>" readonly/></span></td>
							    <td><span><input type="text" class="form-control" name="INL_REF_TXN_NO[]" value="<?php echo $row['INL_REF_TXN_NO'];?>" readonly/></span></td>
							    <td><span><input type="text" class="form-control" name="INL_ITEM_CODE[]" value="<?php echo $row['INL_ITEM_CODE'];?>"/></span></td>
							    <td><span><input type="text" class="form-control" name="INL_ITEM_DESC[]" value="<?php echo $row['INL_ITEM_DESC'];?>"/></span></td>
							    <td><span><input type="text" class="form-control" name="INL_UOM_CODE[]" value="<?php echo $row['INL_UOM_CODE'];?>"/></span></td>
							    <td><span><input type="text" class="form-control" name="INL_QTY[]" value="<?php echo $row['INL_QTY'];?>"/></span></td>
							    <td><span><input type="text" class="form-control" name="INL_ACC_QTY[]" value="<?php echo $row['INL_ACC_QTY'];?>"/></span></td>
							    <td><span><input type="text" class="form-control" name="INL_REJ_QTY[]" value="<?php echo $row['INL_REJ_QTY'];?>"/></span></td>
							    <td><span><input type="text" class="form-control" name="INL_PRICE[]" value="<?php echo $row['INL_PRICE'];?>"/></span></td>
							    <td><span><input type="text" class="form-control" name="INL_VALUE[]" value="<?php echo $row['INL_VALUE'];?>"/></span></td>
							    <td><span>
							    <select class="form-control" id="INL_LOCN_CODE" name="INL_LOCN_CODE[]">
							    <?php foreach($result2 as $row2) { ?>
							    <option value="<?php echo $row2['LOCN_CODE']?>" <?php if($row['INL_LOCN_CODE']==$row2['LOCN_CODE']) echo 'selected'?>><?php echo $row2['LOCN_DESC']?></option>
							    <?php } ?>
							    </select>
							    </span></td>
