...
<div id="content" class="content">
	...
	<li class="active">Edit Item Posting Sub Type Master</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Item Posting Sub Type Master <small> Enter the correct details here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Edit Item Posting Sub Type Master</h4>
		</div>
		<div class="panel-body">
		    <div class="col-md-offset-1 col-md-7">
			<form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo site_url('InventoryController/ItemPostingGroupMaster_Edit');?>" class="form-horizontal">
			    <div class="form-group">
				<label class="col-md-3 control-label">Item Group Code</label>
				<div class="col-md-5">
				    <input type="text" name="pg_code" placeholder="PG_CODE" id="pg_code" value="<?php echo $result[0]['PG_CODE']?>" class="form-control" readonly>
				</div>
				<div class="col-md-offset-2 col-md-2 checkbox">
				    <label>
				    <input type="checkbox" name="pg_active" <?php echo ($result[0]['PG_ACTIVE_YN']=='Y' ? 'checked' : '')?> value="Y">
				    Active ?
				    </label>
				</div>
			    </div>
				...
				<div class="col-md-9">
				    <input type="text" name="pg_desc" value="<?php echo $result[0]['PG_DESC']?>" placeholder="PG_DESC" id="pg_desc" class="form-control">
				</div>
			    </div>
			    <fieldset>
