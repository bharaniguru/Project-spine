...
<div id="content" class="content">
	...
	<li class="active">Edit Item Sub Type Master</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Edit Item Sub Type Master <small> Enter the correct details here...</small></h1>
    <!-- end page-header -->
	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
		    ...
		    <h4 class="panel-title">Edit Item Sub Type Master</h4>
		</div>
		<div class="panel-body">
		    <div class="col-md-offset-1 col-md-7">
			<form id="form_validation" method="POST" enctype="multipart/form-data" action="<?php echo site_url('InventoryController/ItemSubTypeMaster_Edit');?>" class="form-horizontal">
			    <div class="form-group">
				<label class="col-md-3 control-label">Item Sub Type Code</label>
				<div class="col-md-5">
				    <input type="text" name="is_code" value="<?php echo $result[0]['IS_CODE']?>" placeholder="IS_CODE" id="is_code" class="form-control" readonly>
				</div>
				<div class="col-md-offset-2 col-md-2 checkbox">
				    <label>
				    <input type="checkbox" value="Y" name="is_active" <?php echo ($result[0]['IS_ACTIVE_YN']=='Y'? 'checked' : '')?>>
				    Active ?
				    </label>
				</div>
			    </div>
				...
				<div class="col-md-9">
				    <input type="text" name="is_desc" value="<?php echo $result[0]['IS_DESC']?>" placeholder="IS_DESC" id="is_desc" class="form-control">
				</div>
			    </div>
			    <div class="form-group">
				...
				<div class="col-md-9">
				    ...
				    <?php foreach($result1 as $row) { ?>
				    	<option value="<?php echo $row['IG_CODE'] ?>" <?php if($result[0]['IS_IT_CODE']==$row['IG_CODE']) echo 'selected'?>><?php echo $row['IG_DESC'] ?></option>
				    <?php } ?>
				    </select>
				</div>
			    </div>
